...
@XmlEnum
public enum EnumSeatMapOperations_2015B {
    ...
    EnumSeatMapOperations_2015B(String v) {
        value = v;
    }
    ...
    public static EnumSeatMapOperations_2015B fromValue(String v) {
        for (EnumSeatMapOperations_2015B c: EnumSeatMapOperations_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
