...
public class CancelPenaltiesType_2015B {

    @XmlElement(name = "CancelPenalty")
    protected List<CancelPenaltyType_2015B> cancelPenalty;
     ...
     * {@link CancelPenaltyType_2015B }
     * 
     * 
     */
    public List<CancelPenaltyType_2015B> getCancelPenalty() {
        if (cancelPenalty == null) {
            cancelPenalty = new ArrayList<CancelPenaltyType_2015B>();
        }
