...
public class StatisticsType_2015B {

    @XmlElement(name = "Statistic", required = true)
    protected List<StatisticType_2015B> statistic;
     ...
     * {@link StatisticType_2015B }
     * 
     * 
     */
    public List<StatisticType_2015B> getStatistic() {
        if (statistic == null) {
            statistic = new ArrayList<StatisticType_2015B>();
        }
