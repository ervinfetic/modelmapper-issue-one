...
public class CoverageType_2015B {

    @XmlElement(name = "Details")
    protected List<CoverageDetailsType_2015B> details;
     ...
     * {@link CoverageDetailsType_2015B }
     * 
     * 
     */
    public List<CoverageDetailsType_2015B> getDetails() {
        if (details == null) {
            details = new ArrayList<CoverageDetailsType_2015B>();
        }
        return this.details;
    }
