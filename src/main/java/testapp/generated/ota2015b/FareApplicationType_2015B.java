...
@XmlEnum
public enum FareApplicationType_2015B {
    ...
    FareApplicationType_2015B(String v) {
        value = v;
    }
    ...
    public static FareApplicationType_2015B fromValue(String v) {
        for (FareApplicationType_2015B c: FareApplicationType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
