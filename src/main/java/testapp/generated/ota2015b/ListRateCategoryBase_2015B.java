...
@XmlEnum
public enum ListRateCategoryBase_2015B {
    ...
    ListRateCategoryBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListRateCategoryBase_2015B fromValue(String v) {
        for (ListRateCategoryBase_2015B c: ListRateCategoryBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
