...
@XmlEnum
public enum ListOfferTourActivityCategory_2015B {
    ...
    ListOfferTourActivityCategory_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferTourActivityCategory_2015B fromValue(String v) {
        for (ListOfferTourActivityCategory_2015B c: ListOfferTourActivityCategory_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
