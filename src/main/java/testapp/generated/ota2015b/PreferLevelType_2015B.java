...
@XmlEnum
public enum PreferLevelType_2015B {
    ...
    PreferLevelType_2015B(String v) {
        value = v;
    }
    ...
    public static PreferLevelType_2015B fromValue(String v) {
        for (PreferLevelType_2015B c: PreferLevelType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
