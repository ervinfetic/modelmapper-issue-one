...
public class SellableProductsType_2015B {

    @XmlElement(name = "SellableProduct", required = true)
    protected List<SellableProductsType_2015B.SellableProduct_2015B> sellableProduct;
     ...
     * {@link SellableProductsType_2015B.SellableProduct_2015B }
     * 
     * 
     */
    public List<SellableProductsType_2015B.SellableProduct_2015B> getSellableProduct() {
        if (sellableProduct == null) {
            sellableProduct = new ArrayList<SellableProductsType_2015B.SellableProduct_2015B>();
        }
    ...
    public static class SellableProduct_2015B {

        @XmlElement(name = "DestinationSystemCodes")
        protected SellableProductsType_2015B.SellableProduct_2015B.DestinationSystemCodes_2015B destinationSystemCodes;
        @XmlElement(name = "GuestRoom")
        protected GuestRoomType_2015B guestRoom;
        @XmlElement(name = "MeetingRooms")
        protected MeetingRoomsType_2015B meetingRooms;
        @XmlElement(name = "InventoryBlock")
        protected SellableProductsType_2015B.SellableProduct_2015B.InventoryBlock_2015B inventoryBlock;
         ...
         * @return
         *     possible object is
         *     {@link SellableProductsType_2015B.SellableProduct_2015B.DestinationSystemCodes_2015B }
         *     
         */
        public SellableProductsType_2015B.SellableProduct_2015B.DestinationSystemCodes_2015B getDestinationSystemCodes() {
         ...
         *     
         */
        public void setDestinationSystemCodes(SellableProductsType_2015B.SellableProduct_2015B.DestinationSystemCodes_2015B value) {
         ...
         * @return
         *     possible object is
         *     {@link GuestRoomType_2015B }
         *     
         */
        public GuestRoomType_2015B getGuestRoom() {
            return guestRoom;
        }
         ...
         *     
         */
        public void setGuestRoom(GuestRoomType_2015B value) {
         ...
         * @return
         *     possible object is
         *     {@link MeetingRoomsType_2015B }
         *     
         */
        public MeetingRoomsType_2015B getMeetingRooms() {
            return meetingRooms;
        }
         ...
         *     
         */
        public void setMeetingRooms(MeetingRoomsType_2015B value) {
         ...
         * @return
         *     possible object is
         *     {@link SellableProductsType_2015B.SellableProduct_2015B.InventoryBlock_2015B }
         *     
         */
        public SellableProductsType_2015B.SellableProduct_2015B.InventoryBlock_2015B getInventoryBlock() {
         ...
         *     
         */
        public void setInventoryBlock(SellableProductsType_2015B.SellableProduct_2015B.InventoryBlock_2015B value) {
        ...
        public static class DestinationSystemCodes_2015B {

            @XmlElement(name = "DestinationSystemCode", required = true)
            protected List<SellableProductsType_2015B.SellableProduct_2015B.DestinationSystemCodes_2015B.DestinationSystemCode_2015B> destinationSystemCode;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link SellableProductsType_2015B.SellableProduct_2015B.DestinationSystemCodes_2015B.DestinationSystemCode_2015B }
             * 
             * 
             */
            public List<SellableProductsType_2015B.SellableProduct_2015B.DestinationSystemCodes_2015B.DestinationSystemCode_2015B> getDestinationSystemCode() {
                if (destinationSystemCode == null) {
                    destinationSystemCode = new ArrayList<SellableProductsType_2015B.SellableProduct_2015B.DestinationSystemCodes_2015B.DestinationSystemCode_2015B>();
                }
            ...
            public static class DestinationSystemCode_2015B {
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "")
        public static class InventoryBlock_2015B {
