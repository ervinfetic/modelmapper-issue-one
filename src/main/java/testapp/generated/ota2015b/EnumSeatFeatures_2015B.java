...
@XmlEnum
public enum EnumSeatFeatures_2015B {
    ...
    EnumSeatFeatures_2015B(String v) {
        value = v;
    }
    ...
    public static EnumSeatFeatures_2015B fromValue(String v) {
        for (EnumSeatFeatures_2015B c: EnumSeatFeatures_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
