...
public class ServiceRPHsType_2015B {

    @XmlElement(name = "ServiceRPH", required = true)
    protected List<ServiceRPHsType_2015B.ServiceRPH_2015B> serviceRPH;
     ...
     * {@link ServiceRPHsType_2015B.ServiceRPH_2015B }
     * 
     * 
     */
    public List<ServiceRPHsType_2015B.ServiceRPH_2015B> getServiceRPH() {
        if (serviceRPH == null) {
            serviceRPH = new ArrayList<ServiceRPHsType_2015B.ServiceRPH_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class ServiceRPH_2015B {
