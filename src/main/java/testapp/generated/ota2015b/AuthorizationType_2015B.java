...
public class AuthorizationType_2015B {

    @XmlElement(name = "CheckAuthorization")
    protected AuthorizationType_2015B.CheckAuthorization_2015B checkAuthorization;
    @XmlElement(name = "CreditCardAuthorization")
    protected AuthorizationType_2015B.CreditCardAuthorization_2015B creditCardAuthorization;
    @XmlElement(name = "AccountAuthorization")
    protected AuthorizationType_2015B.AccountAuthorization_2015B accountAuthorization;
    @XmlElement(name = "DriversLicenseAuthorization")
    protected DocumentType_2015B driversLicenseAuthorization;
    @XmlElement(name = "BookingReferenceID")
    protected AuthorizationType_2015B.BookingReferenceID_2015B bookingReferenceID;
     ...
     * @return
     *     possible object is
     *     {@link AuthorizationType_2015B.CheckAuthorization_2015B }
     *     
     */
    public AuthorizationType_2015B.CheckAuthorization_2015B getCheckAuthorization() {
     ...
     *     
     */
    public void setCheckAuthorization(AuthorizationType_2015B.CheckAuthorization_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link AuthorizationType_2015B.CreditCardAuthorization_2015B }
     *     
     */
    public AuthorizationType_2015B.CreditCardAuthorization_2015B getCreditCardAuthorization() {
     ...
     *     
     */
    public void setCreditCardAuthorization(AuthorizationType_2015B.CreditCardAuthorization_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link AuthorizationType_2015B.AccountAuthorization_2015B }
     *     
     */
    public AuthorizationType_2015B.AccountAuthorization_2015B getAccountAuthorization() {
     ...
     *     
     */
    public void setAccountAuthorization(AuthorizationType_2015B.AccountAuthorization_2015B value) {
     ...
     *     
     */
    public DocumentType_2015B getDriversLicenseAuthorization() {
     ...
     *     
     */
    public void setDriversLicenseAuthorization(DocumentType_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link AuthorizationType_2015B.BookingReferenceID_2015B }
     *     
     */
    public AuthorizationType_2015B.BookingReferenceID_2015B getBookingReferenceID() {
     ...
     *     
     */
    public void setBookingReferenceID(AuthorizationType_2015B.BookingReferenceID_2015B value) {
    ...
    public static class AccountAuthorization_2015B {

        @XmlElement(name = "AccountInfo")
        protected AuthorizationType_2015B.AccountAuthorization_2015B.AccountInfo_2015B accountInfo;
         ...
         * @return
         *     possible object is
         *     {@link AuthorizationType_2015B.AccountAuthorization_2015B.AccountInfo_2015B }
         *     
         */
        public AuthorizationType_2015B.AccountAuthorization_2015B.AccountInfo_2015B getAccountInfo() {
            return accountInfo;
        }
         ...
         *     
         */
        public void setAccountInfo(AuthorizationType_2015B.AccountAuthorization_2015B.AccountInfo_2015B value) {
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "")
        public static class AccountInfo_2015B {
    ...
    public static class CheckAuthorization_2015B {
    ...
    public static class CreditCardAuthorization_2015B {

        @XmlElement(name = "CreditCard", required = true)
        protected PaymentCardType_2015B creditCard;
        @XmlElement(name = "ID")
        protected List<UniqueIDType_2015B> id;
        ...
        protected TimeUnitType_2015B extendedPaymentFrequency;
         ...
         *     
         */
        public PaymentCardType_2015B getCreditCard() {
            return creditCard;
        }
         ...
         *     
         */
        public void setCreditCard(PaymentCardType_2015B value) {
         ...
         * 
         */
        public List<UniqueIDType_2015B> getID() {
            if (id == null) {
                id = new ArrayList<UniqueIDType_2015B>();
            }
            return this.id;
        }
         ...
         *     
         */
        public TimeUnitType_2015B getExtendedPaymentFrequency() {
         ...
         *     
         */
        public void setExtendedPaymentFrequency(TimeUnitType_2015B value) {
