...
public class AdditionalDetailsType_2015B {

    @XmlElement(name = "AdditionalDetail", required = true)
    protected List<AdditionalDetailType_2015B> additionalDetail;
     ...
     * {@link AdditionalDetailType_2015B }
     * 
     * 
     */
    public List<AdditionalDetailType_2015B> getAdditionalDetail() {
        if (additionalDetail == null) {
            additionalDetail = new ArrayList<AdditionalDetailType_2015B>();
        }
