...
public enum ListSSRBase_2015B {
    ...
    public static ListSSRBase_2015B fromValue(String v) {
        for (ListSSRBase_2015B c: ListSSRBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
