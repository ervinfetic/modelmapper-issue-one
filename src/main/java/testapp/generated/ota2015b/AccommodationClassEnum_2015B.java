...
@XmlEnum
public enum AccommodationClassEnum_2015B {
    ...
    AccommodationClassEnum_2015B(String v) {
        value = v;
    }
    ...
    public static AccommodationClassEnum_2015B fromValue(String v) {
        for (AccommodationClassEnum_2015B c: AccommodationClassEnum_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
