...
public class WeatherInfoType_2015B {

    @XmlElement(name = "Precipitation")
    protected List<WeatherInfoType_2015B.Precipitation_2015B> precipitation;
    @XmlElement(name = "Temperature")
    protected List<WeatherInfoType_2015B.Temperature_2015B> temperature;
     ...
     * {@link WeatherInfoType_2015B.Precipitation_2015B }
     * 
     * 
     */
    public List<WeatherInfoType_2015B.Precipitation_2015B> getPrecipitation() {
        if (precipitation == null) {
            precipitation = new ArrayList<WeatherInfoType_2015B.Precipitation_2015B>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link WeatherInfoType_2015B.Temperature_2015B }
     * 
     * 
     */
    public List<WeatherInfoType_2015B.Temperature_2015B> getTemperature() {
        if (temperature == null) {
            temperature = new ArrayList<WeatherInfoType_2015B.Temperature_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class Precipitation_2015B {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class Temperature_2015B {
