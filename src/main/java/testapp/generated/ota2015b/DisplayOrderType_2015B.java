...
@XmlEnum
public enum DisplayOrderType_2015B {
    ...
    DisplayOrderType_2015B(String v) {
        value = v;
    }
    ...
    public static DisplayOrderType_2015B fromValue(String v) {
        for (DisplayOrderType_2015B c: DisplayOrderType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
