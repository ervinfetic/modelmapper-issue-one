...
@XmlEnum
public enum ListFeeTaxTypeBase_2015B {
    ...
    ListFeeTaxTypeBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListFeeTaxTypeBase_2015B fromValue(String v) {
        for (ListFeeTaxTypeBase_2015B c: ListFeeTaxTypeBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
