...
@XmlSeeAlso({
    PropertyValueMatchType_2015B.class,
    testapp.generated.ota2015b.RoomStayType_2015B.BasicPropertyInfo_2015B.class
})
public class BasicPropertyInfoType_2015B {

    @XmlElement(name = "VendorMessages")
    protected VendorMessagesType_2015B vendorMessages;
    @XmlElement(name = "Position")
    protected BasicPropertyInfoType_2015B.Position_2015B position;
    @XmlElement(name = "Address")
    protected AddressInfoType_2015B address;
    @XmlElement(name = "ContactNumbers")
    protected BasicPropertyInfoType_2015B.ContactNumbers_2015B contactNumbers;
    @XmlElement(name = "Award")
    protected List<BasicPropertyInfoType_2015B.Award_2015B> award;
    @XmlElement(name = "RelativePosition")
    protected RelativePositionType_2015B relativePosition;
    @XmlElement(name = "HotelAmenity")
    protected List<BasicPropertyInfoType_2015B.HotelAmenity_2015B> hotelAmenity;
    @XmlElement(name = "HotelFeature")
    protected List<BasicPropertyInfoType_2015B.HotelFeature_2015B> hotelFeature;
    @XmlElement(name = "Recreation")
    protected List<BasicPropertyInfoType_2015B.Recreation_2015B> recreation;
    @XmlElement(name = "Service")
    protected List<BasicPropertyInfoType_2015B.Service_2015B> service;
    @XmlElement(name = "Policy")
    protected BasicPropertyInfoType_2015B.Policy_2015B policy;
    @XmlElement(name = "HotelMeetingFacility")
    protected List<BasicPropertyInfoType_2015B.HotelMeetingFacility_2015B> hotelMeetingFacility;
     ...
     * @return
     *     possible object is
     *     {@link BasicPropertyInfoType_2015B.Position_2015B }
     *     
     */
    public BasicPropertyInfoType_2015B.Position_2015B getPosition() {
        return position;
    }
     ...
     *     
     */
    public void setPosition(BasicPropertyInfoType_2015B.Position_2015B value) {
        this.position = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link BasicPropertyInfoType_2015B.ContactNumbers_2015B }
     *     
     */
    public BasicPropertyInfoType_2015B.ContactNumbers_2015B getContactNumbers() {
     ...
     *     
     */
    public void setContactNumbers(BasicPropertyInfoType_2015B.ContactNumbers_2015B value) {
     ...
     * {@link BasicPropertyInfoType_2015B.Award_2015B }
     * 
     * 
     */
    public List<BasicPropertyInfoType_2015B.Award_2015B> getAward() {
        if (award == null) {
            award = new ArrayList<BasicPropertyInfoType_2015B.Award_2015B>();
        }
        return this.award;
    }
     ...
     * @return
     *     possible object is
     *     {@link RelativePositionType_2015B }
     *     
     */
    public RelativePositionType_2015B getRelativePosition() {
     ...
     *     
     */
    public void setRelativePosition(RelativePositionType_2015B value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BasicPropertyInfoType_2015B.HotelAmenity_2015B }
     * 
     * 
     */
    public List<BasicPropertyInfoType_2015B.HotelAmenity_2015B> getHotelAmenity() {
        if (hotelAmenity == null) {
            hotelAmenity = new ArrayList<BasicPropertyInfoType_2015B.HotelAmenity_2015B>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BasicPropertyInfoType_2015B.HotelFeature_2015B }
     * 
     * 
     */
    public List<BasicPropertyInfoType_2015B.HotelFeature_2015B> getHotelFeature() {
        if (hotelFeature == null) {
            hotelFeature = new ArrayList<BasicPropertyInfoType_2015B.HotelFeature_2015B>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BasicPropertyInfoType_2015B.Recreation_2015B }
     * 
     * 
     */
    public List<BasicPropertyInfoType_2015B.Recreation_2015B> getRecreation() {
        if (recreation == null) {
            recreation = new ArrayList<BasicPropertyInfoType_2015B.Recreation_2015B>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BasicPropertyInfoType_2015B.Service_2015B }
     * 
     * 
     */
    public List<BasicPropertyInfoType_2015B.Service_2015B> getService() {
        if (service == null) {
            service = new ArrayList<BasicPropertyInfoType_2015B.Service_2015B>();
        }
        return this.service;
    }
     ...
     * @return
     *     possible object is
     *     {@link BasicPropertyInfoType_2015B.Policy_2015B }
     *     
     */
    public BasicPropertyInfoType_2015B.Policy_2015B getPolicy() {
        return policy;
    }
     ...
     *     
     */
    public void setPolicy(BasicPropertyInfoType_2015B.Policy_2015B value) {
        this.policy = value;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BasicPropertyInfoType_2015B.HotelMeetingFacility_2015B }
     * 
     * 
     */
    public List<BasicPropertyInfoType_2015B.HotelMeetingFacility_2015B> getHotelMeetingFacility() {
        if (hotelMeetingFacility == null) {
            hotelMeetingFacility = new ArrayList<BasicPropertyInfoType_2015B.HotelMeetingFacility_2015B>();
        }
    ...
    public static class ContactNumbers_2015B {

        @XmlElement(name = "ContactNumber")
        protected List<BasicPropertyInfoType_2015B.ContactNumbers_2015B.ContactNumber_2015B> contactNumber;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link BasicPropertyInfoType_2015B.ContactNumbers_2015B.ContactNumber_2015B }
         * 
         * 
         */
        public List<BasicPropertyInfoType_2015B.ContactNumbers_2015B.ContactNumber_2015B> getContactNumber() {
            if (contactNumber == null) {
                contactNumber = new ArrayList<BasicPropertyInfoType_2015B.ContactNumbers_2015B.ContactNumber_2015B>();
            }
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "")
        public static class ContactNumber_2015B {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class Policy_2015B {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class Position_2015B {
