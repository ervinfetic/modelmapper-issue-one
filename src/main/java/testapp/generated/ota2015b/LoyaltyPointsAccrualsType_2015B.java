...
public class LoyaltyPointsAccrualsType_2015B {

    @XmlElement(name = "SelectedLoyalty", required = true)
    protected List<LoyaltyPointsAccrualsType_2015B.SelectedLoyalty_2015B> selectedLoyalty;
     ...
     * {@link LoyaltyPointsAccrualsType_2015B.SelectedLoyalty_2015B }
     * 
     * 
     */
    public List<LoyaltyPointsAccrualsType_2015B.SelectedLoyalty_2015B> getSelectedLoyalty() {
        if (selectedLoyalty == null) {
            selectedLoyalty = new ArrayList<LoyaltyPointsAccrualsType_2015B.SelectedLoyalty_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class SelectedLoyalty_2015B {
