...
@XmlEnum
public enum ListOfferVehicleClass_2015B {
    ...
    ListOfferVehicleClass_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferVehicleClass_2015B fromValue(String v) {
        for (ListOfferVehicleClass_2015B c: ListOfferVehicleClass_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
