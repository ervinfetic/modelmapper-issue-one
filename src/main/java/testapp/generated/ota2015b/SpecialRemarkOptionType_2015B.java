...
@XmlEnum
public enum SpecialRemarkOptionType_2015B {
    ...
    SpecialRemarkOptionType_2015B(String v) {
        value = v;
    }
    ...
    public static SpecialRemarkOptionType_2015B fromValue(String v) {
        for (SpecialRemarkOptionType_2015B c: SpecialRemarkOptionType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
