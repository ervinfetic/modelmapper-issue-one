...
public class TaxType_2015B {

    @XmlElement(name = "TaxDescription")
    protected List<ParagraphType_2015B> taxDescription;
     ...
     * 
     */
    public List<ParagraphType_2015B> getTaxDescription() {
        if (taxDescription == null) {
            taxDescription = new ArrayList<ParagraphType_2015B>();
        }
