...
@XmlEnum
public enum RatePeriodSimpleType_2015B {
    ...
    RatePeriodSimpleType_2015B(String v) {
        value = v;
    }
    ...
    public static RatePeriodSimpleType_2015B fromValue(String v) {
        for (RatePeriodSimpleType_2015B c: RatePeriodSimpleType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
