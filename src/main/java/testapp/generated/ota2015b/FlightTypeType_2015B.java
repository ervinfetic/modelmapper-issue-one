...
@XmlEnum
public enum FlightTypeType_2015B {
    ...
    public static FlightTypeType_2015B fromValue(String v) {
        for (FlightTypeType_2015B c: FlightTypeType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
