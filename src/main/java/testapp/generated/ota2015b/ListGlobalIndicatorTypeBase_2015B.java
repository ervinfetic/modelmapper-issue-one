...
@XmlEnum
public enum ListGlobalIndicatorTypeBase_2015B {
    ...
    ListGlobalIndicatorTypeBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListGlobalIndicatorTypeBase_2015B fromValue(String v) {
        for (ListGlobalIndicatorTypeBase_2015B c: ListGlobalIndicatorTypeBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
