...
@XmlEnum
public enum ListGolferTypeBase_2015B {
    ...
    ListGolferTypeBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListGolferTypeBase_2015B fromValue(String v) {
        for (ListGolferTypeBase_2015B c: ListGolferTypeBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
