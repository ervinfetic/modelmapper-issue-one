...
@XmlEnum
public enum ListVehChargePurposeBase_2015B {
    ...
    ListVehChargePurposeBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListVehChargePurposeBase_2015B fromValue(String v) {
        for (ListVehChargePurposeBase_2015B c: ListVehChargePurposeBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
