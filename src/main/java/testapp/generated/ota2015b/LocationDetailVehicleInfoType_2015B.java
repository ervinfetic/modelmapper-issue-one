...
@XmlEnum
public enum LocationDetailVehicleInfoType_2015B {
    ...
    LocationDetailVehicleInfoType_2015B(String v) {
        value = v;
    }
    ...
    public static LocationDetailVehicleInfoType_2015B fromValue(String v) {
        for (LocationDetailVehicleInfoType_2015B c: LocationDetailVehicleInfoType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
