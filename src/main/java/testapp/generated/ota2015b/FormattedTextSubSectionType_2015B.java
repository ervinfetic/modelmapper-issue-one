...
public class FormattedTextSubSectionType_2015B {

    @XmlElement(name = "Paragraph", required = true)
    protected List<ParagraphType_2015B> paragraph;
     ...
     * 
     */
    public List<ParagraphType_2015B> getParagraph() {
        if (paragraph == null) {
            paragraph = new ArrayList<ParagraphType_2015B>();
        }
