...
public class PricedItinerariesType_2015B {

    @XmlElement(name = "PricedItinerary", required = true)
    protected List<PricedItinerariesType_2015B.PricedItinerary_2015B> pricedItinerary;
     ...
     * {@link PricedItinerariesType_2015B.PricedItinerary_2015B }
     * 
     * 
     */
    public List<PricedItinerariesType_2015B.PricedItinerary_2015B> getPricedItinerary() {
        if (pricedItinerary == null) {
            pricedItinerary = new ArrayList<PricedItinerariesType_2015B.PricedItinerary_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class PricedItinerary_2015B
        extends PricedItineraryType_2015B
    {
