...
@XmlEnum
public enum ListOfferLoyaltySector_2015B {
    ...
    ListOfferLoyaltySector_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferLoyaltySector_2015B fromValue(String v) {
        for (ListOfferLoyaltySector_2015B c: ListOfferLoyaltySector_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
