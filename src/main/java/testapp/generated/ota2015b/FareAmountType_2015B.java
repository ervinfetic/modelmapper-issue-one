...
@XmlEnum
public enum FareAmountType_2015B {
    ...
    public static FareAmountType_2015B fromValue(String v) {
        for (FareAmountType_2015B c: FareAmountType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
