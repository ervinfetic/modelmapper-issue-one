...
public class OntologyOfferType_2015B {

    @XmlElement(name = "Offer", required = true)
    protected List<OntologyOfferType_2015B.Offer_2015B> offer;
     ...
     * {@link OntologyOfferType_2015B.Offer_2015B }
     * 
     * 
     */
    public List<OntologyOfferType_2015B.Offer_2015B> getOffer() {
        if (offer == null) {
            offer = new ArrayList<OntologyOfferType_2015B.Offer_2015B>();
        }
        return this.offer;
    }
    ...
    public static class Offer_2015B {
        ...
        @XmlValue
        protected ListOfferTypesRequested_2015B value;
         ...
         * @return
         *     possible object is
         *     {@link ListOfferTypesRequested_2015B }
         *     
         */
        public ListOfferTypesRequested_2015B getValue() {
            return value;
        }
         ...
         *     
         */
        public void setValue(ListOfferTypesRequested_2015B value) {
            this.value = value;
        }
