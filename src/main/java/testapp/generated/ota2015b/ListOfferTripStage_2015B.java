...
@XmlEnum
public enum ListOfferTripStage_2015B {
    ...
    ListOfferTripStage_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferTripStage_2015B fromValue(String v) {
        for (ListOfferTripStage_2015B c: ListOfferTripStage_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
