...
@XmlEnum
public enum ListOfferBookingMethod_2015B {
    ...
    ListOfferBookingMethod_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferBookingMethod_2015B fromValue(String v) {
        for (ListOfferBookingMethod_2015B c: ListOfferBookingMethod_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
