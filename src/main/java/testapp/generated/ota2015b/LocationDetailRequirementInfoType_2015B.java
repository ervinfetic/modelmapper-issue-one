...
@XmlEnum
public enum LocationDetailRequirementInfoType_2015B {
    ...
    LocationDetailRequirementInfoType_2015B(String v) {
        value = v;
    }
    ...
    public static LocationDetailRequirementInfoType_2015B fromValue(String v) {
        for (LocationDetailRequirementInfoType_2015B c: LocationDetailRequirementInfoType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
