...
@XmlEnum
public enum BerthAccommodationType_2015B {
    ...
    BerthAccommodationType_2015B(String v) {
        value = v;
    }
    ...
    public static BerthAccommodationType_2015B fromValue(String v) {
        for (BerthAccommodationType_2015B c: BerthAccommodationType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
