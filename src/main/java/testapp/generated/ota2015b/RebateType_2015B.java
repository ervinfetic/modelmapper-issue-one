...
public class RebateType_2015B {

    @XmlElement(name = "PaymentInformation")
    protected List<PaymentCardType_2015B> paymentInformation;
     ...
     * 
     */
    public List<PaymentCardType_2015B> getPaymentInformation() {
        if (paymentInformation == null) {
            paymentInformation = new ArrayList<PaymentCardType_2015B>();
        }
