...
public class DestinationSystemCodesType_2015B {

    @XmlElement(name = "DestinationSystemCode", required = true)
    protected List<DestinationSystemCodesType_2015B.DestinationSystemCode_2015B> destinationSystemCode;
     ...
     * {@link DestinationSystemCodesType_2015B.DestinationSystemCode_2015B }
     * 
     * 
     */
    public List<DestinationSystemCodesType_2015B.DestinationSystemCode_2015B> getDestinationSystemCode() {
        if (destinationSystemCode == null) {
            destinationSystemCode = new ArrayList<DestinationSystemCodesType_2015B.DestinationSystemCode_2015B>();
        }
