...
public class CodeListDetailExtension_2015B
    extends CodeListSummaryExtension_2015B
{

    @XmlElement(name = "ApplyToLevel")
    protected List<ListApplyToLevel_2015B> applyToLevel;
    @XmlElement(name = "Charge")
    protected List<CodeListFeeType_2015B> charge;
    @XmlElement(name = "Schedule")
    protected List<CodeListScheduleType_2015B> schedule;
     ...
     * {@link ListApplyToLevel_2015B }
     * 
     * 
     */
    public List<ListApplyToLevel_2015B> getApplyToLevel() {
        if (applyToLevel == null) {
            applyToLevel = new ArrayList<ListApplyToLevel_2015B>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CodeListFeeType_2015B }
     * 
     * 
     */
    public List<CodeListFeeType_2015B> getCharge() {
        if (charge == null) {
            charge = new ArrayList<CodeListFeeType_2015B>();
        }
        return this.charge;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CodeListScheduleType_2015B }
     * 
     * 
     */
    public List<CodeListScheduleType_2015B> getSchedule() {
        if (schedule == null) {
            schedule = new ArrayList<CodeListScheduleType_2015B>();
        }
