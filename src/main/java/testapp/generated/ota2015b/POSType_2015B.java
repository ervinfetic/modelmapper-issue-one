...
public class POSType_2015B {

    @XmlElement(name = "Source", required = true)
    protected List<SourceType_2015B> source;
     ...
     * {@link SourceType_2015B }
     * 
     * 
     */
    public List<SourceType_2015B> getSource() {
        if (source == null) {
            source = new ArrayList<SourceType_2015B>();
        }
        return this.source;
    }
