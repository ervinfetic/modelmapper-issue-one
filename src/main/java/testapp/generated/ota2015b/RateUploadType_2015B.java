...
@XmlSeeAlso({
    testapp.generated.ota2015b.RateAmountMessageType_2015B.Rates_2015B.Rate_2015B.class,
    testapp.generated.ota2015b.InvBlockRoomType_2015B.RatePlans_2015B.RatePlan_2015B.class
})
public class RateUploadType_2015B {

    @XmlElement(name = "BaseByGuestAmts")
    protected RateUploadType_2015B.BaseByGuestAmts_2015B baseByGuestAmts;
    @XmlElement(name = "AdditionalGuestAmounts")
    protected RateUploadType_2015B.AdditionalGuestAmounts_2015B additionalGuestAmounts;
    @XmlElement(name = "Fees")
    protected FeesType_2015B fees;
    @XmlElement(name = "GuaranteePolicies")
    protected RateUploadType_2015B.GuaranteePolicies_2015B guaranteePolicies;
    ...
    protected RateUploadType_2015B.MealsIncluded_2015B mealsIncluded;
     ...
     * @return
     *     possible object is
     *     {@link RateUploadType_2015B.BaseByGuestAmts_2015B }
     *     
     */
    public RateUploadType_2015B.BaseByGuestAmts_2015B getBaseByGuestAmts() {
     ...
     *     
     */
    public void setBaseByGuestAmts(RateUploadType_2015B.BaseByGuestAmts_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link RateUploadType_2015B.AdditionalGuestAmounts_2015B }
     *     
     */
    public RateUploadType_2015B.AdditionalGuestAmounts_2015B getAdditionalGuestAmounts() {
     ...
     *     
     */
    public void setAdditionalGuestAmounts(RateUploadType_2015B.AdditionalGuestAmounts_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link RateUploadType_2015B.GuaranteePolicies_2015B }
     *     
     */
    public RateUploadType_2015B.GuaranteePolicies_2015B getGuaranteePolicies() {
     ...
     *     
     */
    public void setGuaranteePolicies(RateUploadType_2015B.GuaranteePolicies_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link RateUploadType_2015B.MealsIncluded_2015B }
     *     
     */
    public RateUploadType_2015B.MealsIncluded_2015B getMealsIncluded() {
     ...
     *     
     */
    public void setMealsIncluded(RateUploadType_2015B.MealsIncluded_2015B value) {
    ...
    public static class AdditionalGuestAmounts_2015B {
        ...
        protected List<RateUploadType_2015B.AdditionalGuestAmounts_2015B.AdditionalGuestAmount_2015B> additionalGuestAmount;
         ...
         * {@link RateUploadType_2015B.AdditionalGuestAmounts_2015B.AdditionalGuestAmount_2015B }
         * 
         * 
         */
        public List<RateUploadType_2015B.AdditionalGuestAmounts_2015B.AdditionalGuestAmount_2015B> getAdditionalGuestAmount() {
            if (additionalGuestAmount == null) {
                additionalGuestAmount = new ArrayList<RateUploadType_2015B.AdditionalGuestAmounts_2015B.AdditionalGuestAmount_2015B>();
            }
        ...
        public static class AdditionalGuestAmount_2015B {

            @XmlElement(name = "Taxes")
            protected TaxesType_2015B taxes;
            @XmlElement(name = "AddlGuestAmtDescription")
            protected List<ParagraphType_2015B> addlGuestAmtDescription;
            @XmlAttribute(name = "TaxInclusive")
            protected Boolean taxInclusive;
            @XmlAttribute(name = "MaxAdditionalGuests")
            protected Integer maxAdditionalGuests;
            @XmlAttribute(name = "Type")
            protected AmountDeterminationType_2015B type;
             ...
             * @return
             *     possible object is
             *     {@link TaxesType_2015B }
             *     
             */
            public TaxesType_2015B getTaxes() {
                return taxes;
            }
             ...
             *     
             */
            public void setTaxes(TaxesType_2015B value) {
                this.taxes = value;
            }
             ...
             * 
             */
            public List<ParagraphType_2015B> getAddlGuestAmtDescription() {
                if (addlGuestAmtDescription == null) {
                    addlGuestAmtDescription = new ArrayList<ParagraphType_2015B>();
                }
             ...
             * @return
             *     possible object is
             *     {@link AmountDeterminationType_2015B }
             *     
             */
            public AmountDeterminationType_2015B getType() {
                return type;
            }
             ...
             *     
             */
            public void setType(AmountDeterminationType_2015B value) {
                this.type = value;
            }
    ...
    public static class BaseByGuestAmts_2015B {

        @XmlElement(name = "BaseByGuestAmt", required = true)
        protected List<RateUploadType_2015B.BaseByGuestAmts_2015B.BaseByGuestAmt_2015B> baseByGuestAmt;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link RateUploadType_2015B.BaseByGuestAmts_2015B.BaseByGuestAmt_2015B }
         * 
         * 
         */
        public List<RateUploadType_2015B.BaseByGuestAmts_2015B.BaseByGuestAmt_2015B> getBaseByGuestAmt() {
            if (baseByGuestAmt == null) {
                baseByGuestAmt = new ArrayList<RateUploadType_2015B.BaseByGuestAmts_2015B.BaseByGuestAmt_2015B>();
            }
        ...
        public static class BaseByGuestAmt_2015B
            extends TotalType_2015B
        {

            @XmlElement(name = "NumberOfGuestsDescription")
            protected List<ParagraphType_2015B> numberOfGuestsDescription;
            @XmlAttribute(name = "Code")
            protected String code;
             ...
             * 
             */
            public List<ParagraphType_2015B> getNumberOfGuestsDescription() {
                if (numberOfGuestsDescription == null) {
                    numberOfGuestsDescription = new ArrayList<ParagraphType_2015B>();
                }
    ...
    public static class GuaranteePolicies_2015B {

        @XmlElement(name = "GuaranteePolicy", required = true)
        protected List<GuaranteeType_2015B> guaranteePolicy;
         ...
         * 
         */
        public List<GuaranteeType_2015B> getGuaranteePolicy() {
            if (guaranteePolicy == null) {
                guaranteePolicy = new ArrayList<GuaranteeType_2015B>();
            }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class MealsIncluded_2015B {
