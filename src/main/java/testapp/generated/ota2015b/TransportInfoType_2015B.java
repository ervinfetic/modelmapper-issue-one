...
public class TransportInfoType_2015B {

    @XmlElement(name = "TransportInfo", required = true)
    protected List<TransportInfoType_2015B.TransportInfo_2015B> transportInfo;
     ...
     * {@link TransportInfoType_2015B.TransportInfo_2015B }
     * 
     * 
     */
    public List<TransportInfoType_2015B.TransportInfo_2015B> getTransportInfo() {
        if (transportInfo == null) {
            transportInfo = new ArrayList<TransportInfoType_2015B.TransportInfo_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class TransportInfo_2015B {
