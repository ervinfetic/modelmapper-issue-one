...
public class PreferencesType_2015B {

    @XmlElement(name = "PrefCollection", required = true)
    protected List<PreferencesType_2015B.PrefCollection_2015B> prefCollection;
     ...
     * {@link PreferencesType_2015B.PrefCollection_2015B }
     * 
     * 
     */
    public List<PreferencesType_2015B.PrefCollection_2015B> getPrefCollection() {
        if (prefCollection == null) {
            prefCollection = new ArrayList<PreferencesType_2015B.PrefCollection_2015B>();
        }
    ...
    public static class PrefCollection_2015B {

        @XmlElement(name = "CommonPref")
        protected List<CommonPrefType_2015B> commonPref;
        @XmlElement(name = "VehicleRentalPref")
        protected List<VehicleProfileRentalPrefType_2015B> vehicleRentalPref;
        @XmlElement(name = "AirlinePref")
        protected List<AirlinePrefType_2015B> airlinePref;
        @XmlElement(name = "HotelPref")
        protected List<HotelPrefType_2015B> hotelPref;
        @XmlElement(name = "RailPref")
        protected List<RailPrefType_2015B> railPref;
        @XmlElement(name = "OtherSrvcPref")
        protected List<OtherSrvcPrefType_2015B> otherSrvcPref;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link CommonPrefType_2015B }
         * 
         * 
         */
        public List<CommonPrefType_2015B> getCommonPref() {
            if (commonPref == null) {
                commonPref = new ArrayList<CommonPrefType_2015B>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link VehicleProfileRentalPrefType_2015B }
         * 
         * 
         */
        public List<VehicleProfileRentalPrefType_2015B> getVehicleRentalPref() {
            if (vehicleRentalPref == null) {
                vehicleRentalPref = new ArrayList<VehicleProfileRentalPrefType_2015B>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link AirlinePrefType_2015B }
         * 
         * 
         */
        public List<AirlinePrefType_2015B> getAirlinePref() {
            if (airlinePref == null) {
                airlinePref = new ArrayList<AirlinePrefType_2015B>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link HotelPrefType_2015B }
         * 
         * 
         */
        public List<HotelPrefType_2015B> getHotelPref() {
            if (hotelPref == null) {
                hotelPref = new ArrayList<HotelPrefType_2015B>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link RailPrefType_2015B }
         * 
         * 
         */
        public List<RailPrefType_2015B> getRailPref() {
            if (railPref == null) {
                railPref = new ArrayList<RailPrefType_2015B>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link OtherSrvcPrefType_2015B }
         * 
         * 
         */
        public List<OtherSrvcPrefType_2015B> getOtherSrvcPref() {
            if (otherSrvcPref == null) {
                otherSrvcPref = new ArrayList<OtherSrvcPrefType_2015B>();
            }
