...
@XmlEnum
public enum ListUnitOfMeasureBase_2015B {
    ...
    ListUnitOfMeasureBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListUnitOfMeasureBase_2015B fromValue(String v) {
        for (ListUnitOfMeasureBase_2015B c: ListUnitOfMeasureBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
