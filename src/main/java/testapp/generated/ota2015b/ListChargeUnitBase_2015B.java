...
@XmlEnum
public enum ListChargeUnitBase_2015B {
    ...
    ListChargeUnitBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListChargeUnitBase_2015B fromValue(String v) {
        for (ListChargeUnitBase_2015B c: ListChargeUnitBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
