...
public class MembershipType_2015B {

    @XmlElement(name = "Membership", required = true)
    protected List<MembershipType_2015B.Membership_2015B> membership;
     ...
     * {@link MembershipType_2015B.Membership_2015B }
     * 
     * 
     */
    public List<MembershipType_2015B.Membership_2015B> getMembership() {
        if (membership == null) {
            membership = new ArrayList<MembershipType_2015B.Membership_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class Membership_2015B {
