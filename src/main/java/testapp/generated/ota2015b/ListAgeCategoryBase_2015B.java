...
@XmlEnum
public enum ListAgeCategoryBase_2015B {
    ...
    ListAgeCategoryBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListAgeCategoryBase_2015B fromValue(String v) {
        for (ListAgeCategoryBase_2015B c: ListAgeCategoryBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
