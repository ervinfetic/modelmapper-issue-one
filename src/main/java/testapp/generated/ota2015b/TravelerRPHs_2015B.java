...
public class TravelerRPHs_2015B {

    @XmlElement(name = "TravelerRPH", required = true)
    protected List<TravelerRPHs_2015B.TravelerRPH_2015B> travelerRPH;
     ...
     * {@link TravelerRPHs_2015B.TravelerRPH_2015B }
     * 
     * 
     */
    public List<TravelerRPHs_2015B.TravelerRPH_2015B> getTravelerRPH() {
        if (travelerRPH == null) {
            travelerRPH = new ArrayList<TravelerRPHs_2015B.TravelerRPH_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class TravelerRPH_2015B {
