...
public class ResGuestType_2015B {
    ...
    protected ResGuestType_2015B.ProfileRPHs_2015B profileRPHs;
    @XmlElement(name = "ArrivalTransport")
    protected TransportInfoType_2015B arrivalTransport;
    @XmlElement(name = "DepartureTransport")
    protected TransportInfoType_2015B departureTransport;
    @XmlElement(name = "GuestCounts")
    protected GuestCountType_2015B guestCounts;
    @XmlElement(name = "InHouseTimeSpan")
    protected DateTimeSpanType_2015B inHouseTimeSpan;
     ...
     * @return
     *     possible object is
     *     {@link ResGuestType_2015B.ProfileRPHs_2015B }
     *     
     */
    public ResGuestType_2015B.ProfileRPHs_2015B getProfileRPHs() {
        return profileRPHs;
    }
     ...
     *     
     */
    public void setProfileRPHs(ResGuestType_2015B.ProfileRPHs_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link TransportInfoType_2015B }
     *     
     */
    public TransportInfoType_2015B getArrivalTransport() {
     ...
     *     
     */
    public void setArrivalTransport(TransportInfoType_2015B value) {
     ...
     *     
     */
    public TransportInfoType_2015B getDepartureTransport() {
     ...
     *     
     */
    public void setDepartureTransport(TransportInfoType_2015B value) {
     ...
     *     
     */
    public DateTimeSpanType_2015B getInHouseTimeSpan() {
     ...
     *     
     */
    public void setInHouseTimeSpan(DateTimeSpanType_2015B value) {
    ...
    public static class ProfileRPHs_2015B {

        @XmlElement(name = "ProfileRPH", required = true)
        protected List<ResGuestType_2015B.ProfileRPHs_2015B.ProfileRPH_2015B> profileRPH;
         ...
         * {@link ResGuestType_2015B.ProfileRPHs_2015B.ProfileRPH_2015B }
         * 
         * 
         */
        public List<ResGuestType_2015B.ProfileRPHs_2015B.ProfileRPH_2015B> getProfileRPH() {
            if (profileRPH == null) {
                profileRPH = new ArrayList<ResGuestType_2015B.ProfileRPHs_2015B.ProfileRPH_2015B>();
            }
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "")
        public static class ProfileRPH_2015B {
