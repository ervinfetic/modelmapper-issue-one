...
public class BlackoutDateType_2015B {

    @XmlElement(name = "BlackoutDate", required = true)
    protected List<DateTimeSpanType_2015B> blackoutDate;
     ...
     * 
     */
    public List<DateTimeSpanType_2015B> getBlackoutDate() {
        if (blackoutDate == null) {
            blackoutDate = new ArrayList<DateTimeSpanType_2015B>();
        }
