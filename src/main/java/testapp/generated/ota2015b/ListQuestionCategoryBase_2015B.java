...
@XmlEnum
public enum ListQuestionCategoryBase_2015B {
    ...
    ListQuestionCategoryBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListQuestionCategoryBase_2015B fromValue(String v) {
        for (ListQuestionCategoryBase_2015B c: ListQuestionCategoryBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
