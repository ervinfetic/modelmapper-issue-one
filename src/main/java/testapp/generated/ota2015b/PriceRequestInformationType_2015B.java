...
@XmlSeeAlso({
    testapp.generated.ota2015b.TravelerInfoSummaryType_2015B.PriceRequestInformation_2015B.class
})
public class PriceRequestInformationType_2015B {

    @XmlElement(name = "NegotiatedFareCode")
    protected List<PriceRequestInformationType_2015B.NegotiatedFareCode_2015B> negotiatedFareCode;
    @XmlElement(name = "RebookOption")
    protected List<PriceRequestInformationType_2015B.RebookOption_2015B> rebookOption;
     ...
     * {@link PriceRequestInformationType_2015B.NegotiatedFareCode_2015B }
     * 
     * 
     */
    public List<PriceRequestInformationType_2015B.NegotiatedFareCode_2015B> getNegotiatedFareCode() {
        if (negotiatedFareCode == null) {
            negotiatedFareCode = new ArrayList<PriceRequestInformationType_2015B.NegotiatedFareCode_2015B>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PriceRequestInformationType_2015B.RebookOption_2015B }
     * 
     * 
     */
    public List<PriceRequestInformationType_2015B.RebookOption_2015B> getRebookOption() {
        if (rebookOption == null) {
            rebookOption = new ArrayList<PriceRequestInformationType_2015B.RebookOption_2015B>();
        }
    ...
    public static class NegotiatedFareCode_2015B {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class RebookOption_2015B {
