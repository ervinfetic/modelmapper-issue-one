...
@XmlEnum
public enum ListAirFareDateTypeBase_2015B {
    ...
    ListAirFareDateTypeBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListAirFareDateTypeBase_2015B fromValue(String v) {
        for (ListAirFareDateTypeBase_2015B c: ListAirFareDateTypeBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
