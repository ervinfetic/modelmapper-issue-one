...
@XmlEnum
public enum LocationDetailShuttleInfoType_2015B {
    ...
    LocationDetailShuttleInfoType_2015B(String v) {
        value = v;
    }
    ...
    public static LocationDetailShuttleInfoType_2015B fromValue(String v) {
        for (LocationDetailShuttleInfoType_2015B c: LocationDetailShuttleInfoType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
