...
@XmlEnum
public enum ListOfferCustomerValueBasis_2015B {
    ...
    ListOfferCustomerValueBasis_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferCustomerValueBasis_2015B fromValue(String v) {
        for (ListOfferCustomerValueBasis_2015B c: ListOfferCustomerValueBasis_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
