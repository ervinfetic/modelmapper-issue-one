...
public class RailPassengerShopTypeDEPRECATE_2015B {

    @XmlElement(name = "Occupation")
    protected RailPassengerOccupationType_2015B occupation;
    @XmlElement(name = "PassengerQualifyingInfo")
    protected List<RailPassengerShopTypeDEPRECATE_2015B.PassengerQualifyingInfo_2015B> passengerQualifyingInfo;
     ...
     * {@link RailPassengerShopTypeDEPRECATE_2015B.PassengerQualifyingInfo_2015B }
     * 
     * 
     */
    public List<RailPassengerShopTypeDEPRECATE_2015B.PassengerQualifyingInfo_2015B> getPassengerQualifyingInfo() {
        if (passengerQualifyingInfo == null) {
            passengerQualifyingInfo = new ArrayList<RailPassengerShopTypeDEPRECATE_2015B.PassengerQualifyingInfo_2015B>();
        }
