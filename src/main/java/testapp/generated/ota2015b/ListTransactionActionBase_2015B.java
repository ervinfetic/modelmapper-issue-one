...
@XmlEnum
public enum ListTransactionActionBase_2015B {
    ...
    ListTransactionActionBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListTransactionActionBase_2015B fromValue(String v) {
        for (ListTransactionActionBase_2015B c: ListTransactionActionBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
