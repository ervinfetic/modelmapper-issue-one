...
public class HotelReservationIDsType_2015B {

    @XmlElement(name = "HotelReservationID", required = true)
    protected List<HotelReservationIDsType_2015B.HotelReservationID_2015B> hotelReservationID;
     ...
     * {@link HotelReservationIDsType_2015B.HotelReservationID_2015B }
     * 
     * 
     */
    public List<HotelReservationIDsType_2015B.HotelReservationID_2015B> getHotelReservationID() {
        if (hotelReservationID == null) {
            hotelReservationID = new ArrayList<HotelReservationIDsType_2015B.HotelReservationID_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class HotelReservationID_2015B {
