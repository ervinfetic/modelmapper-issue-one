...
public class RevenueDetailsType_2015B {

    @XmlElement(name = "RevenueDetail", required = true)
    protected List<RevenueDetailType_2015B> revenueDetail;
     ...
     * {@link RevenueDetailType_2015B }
     * 
     * 
     */
    public List<RevenueDetailType_2015B> getRevenueDetail() {
        if (revenueDetail == null) {
            revenueDetail = new ArrayList<RevenueDetailType_2015B>();
        }
