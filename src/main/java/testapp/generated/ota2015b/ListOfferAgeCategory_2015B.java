...
@XmlEnum
public enum ListOfferAgeCategory_2015B {
    ...
    ListOfferAgeCategory_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferAgeCategory_2015B fromValue(String v) {
        for (ListOfferAgeCategory_2015B c: ListOfferAgeCategory_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
