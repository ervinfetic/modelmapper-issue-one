...
@XmlEnum
public enum ListOfferPetType_2015B {
    ...
    ListOfferPetType_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferPetType_2015B fromValue(String v) {
        for (ListOfferPetType_2015B c: ListOfferPetType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
