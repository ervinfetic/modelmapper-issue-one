...
public class VehicleLocationVehiclesType_2015B {

    @XmlElement(name = "VehicleInfos")
    protected VehicleLocationVehiclesType_2015B.VehicleInfos_2015B vehicleInfos;
    @XmlElement(name = "Vehicle")
    protected List<VehicleLocationVehiclesType_2015B.Vehicle_2015B> vehicle;
     ...
     * @return
     *     possible object is
     *     {@link VehicleLocationVehiclesType_2015B.VehicleInfos_2015B }
     *     
     */
    public VehicleLocationVehiclesType_2015B.VehicleInfos_2015B getVehicleInfos() {
        return vehicleInfos;
    }
     ...
     *     
     */
    public void setVehicleInfos(VehicleLocationVehiclesType_2015B.VehicleInfos_2015B value) {
     ...
     * {@link VehicleLocationVehiclesType_2015B.Vehicle_2015B }
     * 
     * 
     */
    public List<VehicleLocationVehiclesType_2015B.Vehicle_2015B> getVehicle() {
        if (vehicle == null) {
            vehicle = new ArrayList<VehicleLocationVehiclesType_2015B.Vehicle_2015B>();
        }
        return this.vehicle;
    }
    ...
    public static class VehicleInfos_2015B {

        @XmlElement(name = "VehicleInfo", required = true)
        protected List<VehicleLocationVehiclesType_2015B.VehicleInfos_2015B.VehicleInfo_2015B> vehicleInfo;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link VehicleLocationVehiclesType_2015B.VehicleInfos_2015B.VehicleInfo_2015B }
         * 
         * 
         */
        public List<VehicleLocationVehiclesType_2015B.VehicleInfos_2015B.VehicleInfo_2015B> getVehicleInfo() {
            if (vehicleInfo == null) {
                vehicleInfo = new ArrayList<VehicleLocationVehiclesType_2015B.VehicleInfos_2015B.VehicleInfo_2015B>();
            }
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "")
        public static class VehicleInfo_2015B
            extends FormattedTextType_2015B
        {

            @XmlAttribute(name = "Type", required = true)
            protected LocationDetailVehicleInfoType_2015B type;
             ...
             * @return
             *     possible object is
             *     {@link LocationDetailVehicleInfoType_2015B }
             *     
             */
            public LocationDetailVehicleInfoType_2015B getType() {
                return type;
            }
             ...
             *     
             */
            public void setType(LocationDetailVehicleInfoType_2015B value) {
                this.type = value;
            }
        ...
        extends VehicleType_2015B
    {
         ...
         * 
         */
        public List<FormattedTextType_2015B> getText() {
            if (text == null) {
                text = new ArrayList<FormattedTextType_2015B>();
            }
            return this.text;
        }
         ...
         *     
         */
        public DistanceUnitNameType_2015B getDistanceUnit() {
            return distanceUnit;
        }
         ...
         *     
         */
        public void setDistanceUnit(DistanceUnitNameType_2015B value) {
