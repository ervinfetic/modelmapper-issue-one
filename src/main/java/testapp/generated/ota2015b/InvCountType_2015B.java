...
public class InvCountType_2015B {

    @XmlElement(name = "Inventory", required = true)
    protected List<BaseInvCountType_2015B> inventory;
     ...
     * {@link BaseInvCountType_2015B }
     * 
     * 
     */
    public List<BaseInvCountType_2015B> getInventory() {
        if (inventory == null) {
            inventory = new ArrayList<BaseInvCountType_2015B>();
        }
