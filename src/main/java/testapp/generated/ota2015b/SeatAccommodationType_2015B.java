...
@XmlEnum
public enum SeatAccommodationType_2015B {
    ...
    SeatAccommodationType_2015B(String v) {
        value = v;
    }
    ...
    public static SeatAccommodationType_2015B fromValue(String v) {
        for (SeatAccommodationType_2015B c: SeatAccommodationType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
