...
@XmlSeeAlso({
    testapp.generated.ota2015b.SpecialReqDetailsType_2015B.OtherServiceInformations_2015B.OtherServiceInformation_2015B.class
})
public class OtherServiceInfoType_2015B {

    @XmlElement(name = "TravelerRefNumber")
    protected List<OtherServiceInfoType_2015B.TravelerRefNumber_2015B> travelerRefNumber;
     ...
     * {@link OtherServiceInfoType_2015B.TravelerRefNumber_2015B }
     * 
     * 
     */
    public List<OtherServiceInfoType_2015B.TravelerRefNumber_2015B> getTravelerRefNumber() {
        if (travelerRefNumber == null) {
            travelerRefNumber = new ArrayList<OtherServiceInfoType_2015B.TravelerRefNumber_2015B>();
        }
