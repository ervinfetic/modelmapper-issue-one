...
@XmlEnum
public enum ListOfferAvailabilityStartFormula_2015B {
    ...
    ListOfferAvailabilityStartFormula_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferAvailabilityStartFormula_2015B fromValue(String v) {
        for (ListOfferAvailabilityStartFormula_2015B c: ListOfferAvailabilityStartFormula_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
