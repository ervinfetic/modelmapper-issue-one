...
public class GuestCountType_2015B {

    @XmlElement(name = "GuestCount", required = true)
    protected List<GuestCountType_2015B.GuestCount_2015B> guestCount;
     ...
     * {@link GuestCountType_2015B.GuestCount_2015B }
     * 
     * 
     */
    public List<GuestCountType_2015B.GuestCount_2015B> getGuestCount() {
        if (guestCount == null) {
            guestCount = new ArrayList<GuestCountType_2015B.GuestCount_2015B>();
        }
