...
@XmlEnum
public enum ListOfferPaymentStatus_2015B {
    ...
    ListOfferPaymentStatus_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferPaymentStatus_2015B fromValue(String v) {
        for (ListOfferPaymentStatus_2015B c: ListOfferPaymentStatus_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
