...
@XmlEnum
public enum ListCabinClassBase_2015B {
    ...
    ListCabinClassBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListCabinClassBase_2015B fromValue(String v) {
        for (ListCabinClassBase_2015B c: ListCabinClassBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
