...
public class ErrorsType_2015B {

    @XmlElement(name = "Error", required = true)
    protected List<ErrorType_2015B> error;
     ...
     * {@link ErrorType_2015B }
     * 
     * 
     */
    public List<ErrorType_2015B> getError() {
        if (error == null) {
            error = new ArrayList<ErrorType_2015B>();
        }
        return this.error;
    }
