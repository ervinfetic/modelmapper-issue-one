...
@XmlEnum
public enum ListPaymentCardIssuerBase_2015B {
    ...
    ListPaymentCardIssuerBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListPaymentCardIssuerBase_2015B fromValue(String v) {
        for (ListPaymentCardIssuerBase_2015B c: ListPaymentCardIssuerBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
