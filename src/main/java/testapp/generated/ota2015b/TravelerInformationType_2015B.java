...
public class TravelerInformationType_2015B {

    @XmlElement(name = "PassengerTypeQuantity", required = true)
    protected List<PassengerTypeQuantityType_2015B> passengerTypeQuantity;
    @XmlElement(name = "AirTraveler")
    protected AirTravelerType_2015B airTraveler;
     ...
     * 
     */
    public List<PassengerTypeQuantityType_2015B> getPassengerTypeQuantity() {
        if (passengerTypeQuantity == null) {
            passengerTypeQuantity = new ArrayList<PassengerTypeQuantityType_2015B>();
        }
     ...
     * @return
     *     possible object is
     *     {@link AirTravelerType_2015B }
     *     
     */
    public AirTravelerType_2015B getAirTraveler() {
        return airTraveler;
    }
     ...
     *     
     */
    public void setAirTraveler(AirTravelerType_2015B value) {
