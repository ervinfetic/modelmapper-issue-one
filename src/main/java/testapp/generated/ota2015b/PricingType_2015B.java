...
public enum PricingType_2015B {
    ...
    public static PricingType_2015B fromValue(String v) {
        for (PricingType_2015B c: PricingType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
