...
public class VendorMessagesType_2015B {

    @XmlElement(name = "VendorMessage", required = true)
    protected List<VendorMessageType_2015B> vendorMessage;
     ...
     * {@link VendorMessageType_2015B }
     * 
     * 
     */
    public List<VendorMessageType_2015B> getVendorMessage() {
        if (vendorMessage == null) {
            vendorMessage = new ArrayList<VendorMessageType_2015B>();
        }
