...
@XmlEnum
public enum ListOfferTypesRequested_2015B {
    ...
    ListOfferTypesRequested_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferTypesRequested_2015B fromValue(String v) {
        for (ListOfferTypesRequested_2015B c: ListOfferTypesRequested_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
