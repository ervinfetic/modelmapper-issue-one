...
public enum AirTripType_2015B {
    ...
    public static AirTripType_2015B fromValue(String v) {
        for (AirTripType_2015B c: AirTripType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
