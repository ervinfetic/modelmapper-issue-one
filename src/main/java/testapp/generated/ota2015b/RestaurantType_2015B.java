...
public class RestaurantType_2015B {

    @XmlElement(name = "MultimediaDescriptions")
    protected RestaurantType_2015B.MultimediaDescriptions_2015B multimediaDescriptions;
    @XmlElement(name = "RelativePosition")
    protected RelativePositionType_2015B relativePosition;
    @XmlElement(name = "OperationSchedules")
    protected OperationSchedulesPlusChargeType_2015B operationSchedules;
    @XmlElement(name = "InfoCodes")
    protected RestaurantType_2015B.InfoCodes_2015B infoCodes;
    @XmlElement(name = "CuisineCodes")
    protected RestaurantType_2015B.CuisineCodes_2015B cuisineCodes;
     ...
     * @return
     *     possible object is
     *     {@link RestaurantType_2015B.MultimediaDescriptions_2015B }
     *     
     */
    public RestaurantType_2015B.MultimediaDescriptions_2015B getMultimediaDescriptions() {
     ...
     *     
     */
    public void setMultimediaDescriptions(RestaurantType_2015B.MultimediaDescriptions_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link OperationSchedulesPlusChargeType_2015B }
     *     
     */
    public OperationSchedulesPlusChargeType_2015B getOperationSchedules() {
     ...
     *     
     */
    public void setOperationSchedules(OperationSchedulesPlusChargeType_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link RestaurantType_2015B.InfoCodes_2015B }
     *     
     */
    public RestaurantType_2015B.InfoCodes_2015B getInfoCodes() {
        return infoCodes;
    }
     ...
     *     
     */
    public void setInfoCodes(RestaurantType_2015B.InfoCodes_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link RestaurantType_2015B.CuisineCodes_2015B }
     *     
     */
    public RestaurantType_2015B.CuisineCodes_2015B getCuisineCodes() {
        return cuisineCodes;
    }
     ...
     *     
     */
    public void setCuisineCodes(RestaurantType_2015B.CuisineCodes_2015B value) {
    ...
    public static class CuisineCodes_2015B {

        @XmlElement(name = "CuisineCode", required = true)
        protected List<RestaurantType_2015B.CuisineCodes_2015B.CuisineCode_2015B> cuisineCode;
         ...
         * {@link RestaurantType_2015B.CuisineCodes_2015B.CuisineCode_2015B }
         * 
         * 
         */
        public List<RestaurantType_2015B.CuisineCodes_2015B.CuisineCode_2015B> getCuisineCode() {
            if (cuisineCode == null) {
                cuisineCode = new ArrayList<RestaurantType_2015B.CuisineCodes_2015B.CuisineCode_2015B>();
            }
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "")
        public static class CuisineCode_2015B {
    ...
    public static class InfoCodes_2015B {

        @XmlElement(name = "InfoCode", required = true)
        protected List<RestaurantType_2015B.InfoCodes_2015B.InfoCode_2015B> infoCode;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link RestaurantType_2015B.InfoCodes_2015B.InfoCode_2015B }
         * 
         * 
         */
        public List<RestaurantType_2015B.InfoCodes_2015B.InfoCode_2015B> getInfoCode() {
            if (infoCode == null) {
                infoCode = new ArrayList<RestaurantType_2015B.InfoCodes_2015B.InfoCode_2015B>();
            }
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "")
        public static class InfoCode_2015B {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class MultimediaDescriptions_2015B
        extends MultimediaDescriptionsType_2015B
    {
