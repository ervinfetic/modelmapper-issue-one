...
@XmlEnum
public enum ListGroundServiceProvidedBase_2015B {
    ...
    ListGroundServiceProvidedBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListGroundServiceProvidedBase_2015B fromValue(String v) {
        for (ListGroundServiceProvidedBase_2015B c: ListGroundServiceProvidedBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
