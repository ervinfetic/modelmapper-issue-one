...
@XmlEnum
public enum ListDataActionTypeBase_2015B {
    ...
    ListDataActionTypeBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListDataActionTypeBase_2015B fromValue(String v) {
        for (ListDataActionTypeBase_2015B c: ListDataActionTypeBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
