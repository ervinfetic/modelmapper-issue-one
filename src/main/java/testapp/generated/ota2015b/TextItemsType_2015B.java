...
public class TextItemsType_2015B {

    @XmlElement(name = "TextItem", required = true)
    protected List<TextItemsType_2015B.TextItem_2015B> textItem;
     ...
     * {@link TextItemsType_2015B.TextItem_2015B }
     * 
     * 
     */
    public List<TextItemsType_2015B.TextItem_2015B> getTextItem() {
        if (textItem == null) {
            textItem = new ArrayList<TextItemsType_2015B.TextItem_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class TextItem_2015B
        extends TextDescriptionType_2015B
    {
