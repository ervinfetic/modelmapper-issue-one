...
@XmlEnum
public enum ListOfferDurationUOM_2015B {
    ...
    ListOfferDurationUOM_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferDurationUOM_2015B fromValue(String v) {
        for (ListOfferDurationUOM_2015B c: ListOfferDurationUOM_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
