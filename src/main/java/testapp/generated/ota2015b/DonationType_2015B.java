...
public class DonationType_2015B {

    @XmlElement(name = "FrontOfficeInfo")
    protected DonationType_2015B.FrontOfficeInfo_2015B frontOfficeInfo;
    @XmlElement(name = "CreditCardInfo", required = true)
    protected DonationType_2015B.CreditCardInfo_2015B creditCardInfo;
    @XmlElement(name = "DonorInfo")
    protected DonationType_2015B.DonorInfo_2015B donorInfo;
     ...
     * @return
     *     possible object is
     *     {@link DonationType_2015B.FrontOfficeInfo_2015B }
     *     
     */
    public DonationType_2015B.FrontOfficeInfo_2015B getFrontOfficeInfo() {
     ...
     *     
     */
    public void setFrontOfficeInfo(DonationType_2015B.FrontOfficeInfo_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link DonationType_2015B.CreditCardInfo_2015B }
     *     
     */
    public DonationType_2015B.CreditCardInfo_2015B getCreditCardInfo() {
     ...
     *     
     */
    public void setCreditCardInfo(DonationType_2015B.CreditCardInfo_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link DonationType_2015B.DonorInfo_2015B }
     *     
     */
    public DonationType_2015B.DonorInfo_2015B getDonorInfo() {
        return donorInfo;
    }
     ...
     *     
     */
    public void setDonorInfo(DonationType_2015B.DonorInfo_2015B value) {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class CreditCardInfo_2015B
        extends PaymentCardType_2015B
    {
    ...
    public static class DonorInfo_2015B {

        @XmlElement(name = "Name")
        protected DonationType_2015B.DonorInfo_2015B.Name_2015B name;
        @XmlElement(name = "ContactInfo")
        protected DonationType_2015B.DonorInfo_2015B.ContactInfo_2015B contactInfo;
         ...
         * @return
         *     possible object is
         *     {@link DonationType_2015B.DonorInfo_2015B.Name_2015B }
         *     
         */
        public DonationType_2015B.DonorInfo_2015B.Name_2015B getName() {
            return name;
        }
         ...
         *     
         */
        public void setName(DonationType_2015B.DonorInfo_2015B.Name_2015B value) {
            this.name = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link DonationType_2015B.DonorInfo_2015B.ContactInfo_2015B }
         *     
         */
        public DonationType_2015B.DonorInfo_2015B.ContactInfo_2015B getContactInfo() {
            return contactInfo;
        }
         ...
         *     
         */
        public void setContactInfo(DonationType_2015B.DonorInfo_2015B.ContactInfo_2015B value) {
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "")
        public static class ContactInfo_2015B
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "")
        public static class Name_2015B
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class FrontOfficeInfo_2015B {
