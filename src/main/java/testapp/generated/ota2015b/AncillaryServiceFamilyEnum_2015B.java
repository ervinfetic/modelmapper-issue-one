...
@XmlEnum
public enum AncillaryServiceFamilyEnum_2015B {
    ...
    AncillaryServiceFamilyEnum_2015B(String v) {
        value = v;
    }
    ...
    public static AncillaryServiceFamilyEnum_2015B fromValue(String v) {
        for (AncillaryServiceFamilyEnum_2015B c: AncillaryServiceFamilyEnum_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
