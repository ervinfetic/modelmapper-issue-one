...
@XmlEnum
public enum ListOfferTripMode_2015B {
    ...
    ListOfferTripMode_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferTripMode_2015B fromValue(String v) {
        for (ListOfferTripMode_2015B c: ListOfferTripMode_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
