...
@XmlEnum
public enum InventoryStatusType_2015B {
    ...
    InventoryStatusType_2015B(String v) {
        value = v;
    }
    ...
    public static InventoryStatusType_2015B fromValue(String v) {
        for (InventoryStatusType_2015B c: InventoryStatusType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
