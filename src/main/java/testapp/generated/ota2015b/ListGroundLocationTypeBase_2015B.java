...
@XmlEnum
public enum ListGroundLocationTypeBase_2015B {
    ...
    ListGroundLocationTypeBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListGroundLocationTypeBase_2015B fromValue(String v) {
        for (ListGroundLocationTypeBase_2015B c: ListGroundLocationTypeBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
