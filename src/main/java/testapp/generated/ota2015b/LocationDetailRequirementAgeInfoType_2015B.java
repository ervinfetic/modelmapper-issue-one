...
@XmlEnum
public enum LocationDetailRequirementAgeInfoType_2015B {
    ...
    LocationDetailRequirementAgeInfoType_2015B(String v) {
        value = v;
    }
    ...
    public static LocationDetailRequirementAgeInfoType_2015B fromValue(String v) {
        for (LocationDetailRequirementAgeInfoType_2015B c: LocationDetailRequirementAgeInfoType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
