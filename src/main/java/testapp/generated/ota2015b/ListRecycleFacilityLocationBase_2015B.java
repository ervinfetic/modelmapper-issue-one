...
@XmlEnum
public enum ListRecycleFacilityLocationBase_2015B {
    ...
    ListRecycleFacilityLocationBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListRecycleFacilityLocationBase_2015B fromValue(String v) {
        for (ListRecycleFacilityLocationBase_2015B c: ListRecycleFacilityLocationBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
