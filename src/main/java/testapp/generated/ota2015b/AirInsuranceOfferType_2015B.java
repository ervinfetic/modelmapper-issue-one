...
@XmlSeeAlso({
    AirPricedInsuranceType_2015B.class
})
public class AirInsuranceOfferType_2015B {

    @XmlElement(name = "ProviderCompany")
    protected CompanyNameType_2015B providerCompany;
    @XmlElement(name = "TotalTripCost")
    protected AirInsuranceOfferType_2015B.TotalTripCost_2015B totalTripCost;
    @XmlElement(name = "CoveredTraveler")
    protected List<SearchTravelerType_2015B> coveredTraveler;
     ...
     *     
     */
    public CompanyNameType_2015B getProviderCompany() {
     ...
     *     
     */
    public void setProviderCompany(CompanyNameType_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link AirInsuranceOfferType_2015B.TotalTripCost_2015B }
     *     
     */
    public AirInsuranceOfferType_2015B.TotalTripCost_2015B getTotalTripCost() {
     ...
     *     
     */
    public void setTotalTripCost(AirInsuranceOfferType_2015B.TotalTripCost_2015B value) {
     ...
     * {@link SearchTravelerType_2015B }
     * 
     * 
     */
    public List<SearchTravelerType_2015B> getCoveredTraveler() {
        if (coveredTraveler == null) {
            coveredTraveler = new ArrayList<SearchTravelerType_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class TotalTripCost_2015B {
