...
@XmlSeeAlso({
    testapp.generated.ota2015b.HotelReservationsType_2015B.HotelReservation_2015B.class,
    testapp.generated.ota2015b.HotelResModifyType_2015B.HotelResModify_2015B.class
})
public class HotelReservationType_2015B {

    @XmlElement(name = "POS")
    protected POSType_2015B pos;
    @XmlElement(name = "UniqueID")
    protected List<UniqueIDType_2015B> uniqueID;
    @XmlElement(name = "RoomStays")
    protected RoomStaysType_2015B roomStays;
    @XmlElement(name = "Services")
    protected ServicesType_2015B services;
    @XmlElement(name = "BillingInstructionCode")
    protected List<HotelReservationType_2015B.BillingInstructionCode_2015B> billingInstructionCode;
    @XmlElement(name = "ResGuests")
    protected ResGuestsType_2015B resGuests;
    @XmlElement(name = "ResGlobalInfo")
    protected HotelReservationType_2015B.ResGlobalInfo_2015B resGlobalInfo;
    @XmlElement(name = "WrittenConfInst")
    protected WrittenConfInstType_2015B writtenConfInst;
    @XmlElement(name = "Queue")
    protected HotelReservationType_2015B.Queue_2015B queue;
     ...
     *     
     */
    public void setPOS(POSType_2015B value) {
        this.pos = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link RoomStaysType_2015B }
     *     
     */
    public RoomStaysType_2015B getRoomStays() {
        return roomStays;
    }
     ...
     *     
     */
    public void setRoomStays(RoomStaysType_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link ServicesType_2015B }
     *     
     */
    public ServicesType_2015B getServices() {
        return services;
    }
     ...
     *     
     */
    public void setServices(ServicesType_2015B value) {
        this.services = value;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link HotelReservationType_2015B.BillingInstructionCode_2015B }
     * 
     * 
     */
    public List<HotelReservationType_2015B.BillingInstructionCode_2015B> getBillingInstructionCode() {
        if (billingInstructionCode == null) {
            billingInstructionCode = new ArrayList<HotelReservationType_2015B.BillingInstructionCode_2015B>();
        }
     ...
     * @return
     *     possible object is
     *     {@link ResGuestsType_2015B }
     *     
     */
    public ResGuestsType_2015B getResGuests() {
        return resGuests;
    }
     ...
     *     
     */
    public void setResGuests(ResGuestsType_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link HotelReservationType_2015B.ResGlobalInfo_2015B }
     *     
     */
    public HotelReservationType_2015B.ResGlobalInfo_2015B getResGlobalInfo() {
     ...
     *     
     */
    public void setResGlobalInfo(HotelReservationType_2015B.ResGlobalInfo_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link HotelReservationType_2015B.Queue_2015B }
     *     
     */
    public HotelReservationType_2015B.Queue_2015B getQueue() {
        return queue;
    }
     ...
     *     
     */
    public void setQueue(HotelReservationType_2015B.Queue_2015B value) {
        this.queue = value;
    }
    ...
    public static class BillingInstructionCode_2015B {

        @XmlElement(name = "ResGuestRPH")
        protected List<HotelReservationType_2015B.BillingInstructionCode_2015B.ResGuestRPH_2015B> resGuestRPH;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link HotelReservationType_2015B.BillingInstructionCode_2015B.ResGuestRPH_2015B }
         * 
         * 
         */
        public List<HotelReservationType_2015B.BillingInstructionCode_2015B.ResGuestRPH_2015B> getResGuestRPH() {
            if (resGuestRPH == null) {
                resGuestRPH = new ArrayList<HotelReservationType_2015B.BillingInstructionCode_2015B.ResGuestRPH_2015B>();
            }
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "")
        public static class ResGuestRPH_2015B {
    ...
    public static class ResGlobalInfo_2015B
        extends ResGlobalInfoType_2015B
    {

        @XmlElement(name = "BasicPropertyInfo", required = true)
        protected BasicPropertyInfoType_2015B basicPropertyInfo;
         ...
         * @return
         *     possible object is
         *     {@link BasicPropertyInfoType_2015B }
         *     
         */
        public BasicPropertyInfoType_2015B getBasicPropertyInfo() {
         ...
         *     
         */
        public void setBasicPropertyInfo(BasicPropertyInfoType_2015B value) {
