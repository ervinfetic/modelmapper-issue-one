...
@XmlEnum
public enum ListApplyToLevelBase_2015B {
    ...
    ListApplyToLevelBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListApplyToLevelBase_2015B fromValue(String v) {
        for (ListApplyToLevelBase_2015B c: ListApplyToLevelBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
