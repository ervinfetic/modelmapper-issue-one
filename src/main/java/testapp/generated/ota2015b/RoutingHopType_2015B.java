...
public class RoutingHopType_2015B {

    @XmlElement(name = "RoutingHop", required = true)
    protected List<RoutingHopType_2015B.RoutingHop_2015B> routingHop;
     ...
     * {@link RoutingHopType_2015B.RoutingHop_2015B }
     * 
     * 
     */
    public List<RoutingHopType_2015B.RoutingHop_2015B> getRoutingHop() {
        if (routingHop == null) {
            routingHop = new ArrayList<RoutingHopType_2015B.RoutingHop_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class RoutingHop_2015B {
