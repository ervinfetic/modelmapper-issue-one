...
public class ServicesType_2015B {

    @XmlElement(name = "Service", required = true)
    protected List<ServiceType_2015B> service;
    @XmlElement(name = "ServiceCategory")
    protected List<ServicesType_2015B.ServiceCategory_2015B> serviceCategory;
     ...
     * {@link ServiceType_2015B }
     * 
     * 
     */
    public List<ServiceType_2015B> getService() {
        if (service == null) {
            service = new ArrayList<ServiceType_2015B>();
        }
        return this.service;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ServicesType_2015B.ServiceCategory_2015B }
     * 
     * 
     */
    public List<ServicesType_2015B.ServiceCategory_2015B> getServiceCategory() {
        if (serviceCategory == null) {
            serviceCategory = new ArrayList<ServicesType_2015B.ServiceCategory_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class ServiceCategory_2015B {
