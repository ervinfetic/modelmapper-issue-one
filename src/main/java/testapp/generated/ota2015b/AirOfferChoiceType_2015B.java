...
public class AirOfferChoiceType_2015B {

    @XmlElement(name = "Summary")
    protected List<AirOfferChoiceType_2015B.Summary_2015B> summary;
    @XmlElement(name = "Priced")
    protected List<AirOfferChoiceType_2015B.Priced_2015B> priced;
    @XmlElement(name = "Purchased")
    protected List<AirPurchasedOfferType_2015B> purchased;
     ...
     * {@link AirOfferChoiceType_2015B.Summary_2015B }
     * 
     * 
     */
    public List<AirOfferChoiceType_2015B.Summary_2015B> getSummary() {
        if (summary == null) {
            summary = new ArrayList<AirOfferChoiceType_2015B.Summary_2015B>();
        }
        return this.summary;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AirOfferChoiceType_2015B.Priced_2015B }
     * 
     * 
     */
    public List<AirOfferChoiceType_2015B.Priced_2015B> getPriced() {
        if (priced == null) {
            priced = new ArrayList<AirOfferChoiceType_2015B.Priced_2015B>();
        }
        return this.priced;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AirPurchasedOfferType_2015B }
     * 
     * 
     */
    public List<AirPurchasedOfferType_2015B> getPurchased() {
        if (purchased == null) {
            purchased = new ArrayList<AirPurchasedOfferType_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class Priced_2015B
        extends AirPricedOfferType_2015B
    {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class Summary_2015B
        extends AirOfferType_2015B
    {
