...
@XmlEnum
public enum SeatPositionType_2015B {
    ...
    SeatPositionType_2015B(String v) {
        value = v;
    }
    ...
    public static SeatPositionType_2015B fromValue(String v) {
        for (SeatPositionType_2015B c: SeatPositionType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
