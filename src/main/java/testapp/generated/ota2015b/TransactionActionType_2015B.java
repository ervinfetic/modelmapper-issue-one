...
@XmlEnum
public enum TransactionActionType_2015B {
    ...
    TransactionActionType_2015B(String v) {
        value = v;
    }
    ...
    public static TransactionActionType_2015B fromValue(String v) {
        for (TransactionActionType_2015B c: TransactionActionType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
