...
@XmlEnum
public enum ListAirTripTypeBase_2015B {
    ...
    ListAirTripTypeBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListAirTripTypeBase_2015B fromValue(String v) {
        for (ListAirTripTypeBase_2015B c: ListAirTripTypeBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
