...
@XmlEnum
public enum ListOfferPropertyClassType_2015B {
    ...
    ListOfferPropertyClassType_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferPropertyClassType_2015B fromValue(String v) {
        for (ListOfferPropertyClassType_2015B c: ListOfferPropertyClassType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
