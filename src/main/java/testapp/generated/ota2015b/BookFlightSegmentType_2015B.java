...
@XmlSeeAlso({
    testapp.generated.ota2015b.PTCFareBreakdownType_2015B.PricingUnit_2015B.FareComponent_2015B.FlightLeg_2015B.class,
    testapp.generated.ota2015b.OriginDestinationOptionType_2015B.FlightSegment_2015B.class
})
public class BookFlightSegmentType_2015B
    extends FlightSegmentType_2015B
{

    @XmlElement(name = "MarriageGrp")
    protected String marriageGrp;
    @XmlElement(name = "BookingClassAvails")
    protected List<BookFlightSegmentType_2015B.BookingClassAvails_2015B> bookingClassAvails;
    @XmlElement(name = "Comment")
    protected List<FreeTextType_2015B> comment;
    @XmlElement(name = "StopLocation")
    protected List<BookFlightSegmentType_2015B.StopLocation_2015B> stopLocation;
    ...
    protected DayOfWeekType_2015B departureDay;
     ...
     * {@link BookFlightSegmentType_2015B.BookingClassAvails_2015B }
     * 
     * 
     */
    public List<BookFlightSegmentType_2015B.BookingClassAvails_2015B> getBookingClassAvails() {
        if (bookingClassAvails == null) {
            bookingClassAvails = new ArrayList<BookFlightSegmentType_2015B.BookingClassAvails_2015B>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BookFlightSegmentType_2015B.StopLocation_2015B }
     * 
     * 
     */
    public List<BookFlightSegmentType_2015B.StopLocation_2015B> getStopLocation() {
        if (stopLocation == null) {
            stopLocation = new ArrayList<BookFlightSegmentType_2015B.StopLocation_2015B>();
        }
     ...
     *     
     */
    public DayOfWeekType_2015B getDepartureDay() {
        return departureDay;
    }
     ...
     *     
     */
    public void setDepartureDay(DayOfWeekType_2015B value) {
    ...
    public static class BookingClassAvails_2015B {

        @XmlElement(name = "BookingClassAvail", required = true)
        protected List<BookFlightSegmentType_2015B.BookingClassAvails_2015B.BookingClassAvail_2015B> bookingClassAvail;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link BookFlightSegmentType_2015B.BookingClassAvails_2015B.BookingClassAvail_2015B }
         * 
         * 
         */
        public List<BookFlightSegmentType_2015B.BookingClassAvails_2015B.BookingClassAvail_2015B> getBookingClassAvail() {
            if (bookingClassAvail == null) {
                bookingClassAvail = new ArrayList<BookFlightSegmentType_2015B.BookingClassAvails_2015B.BookingClassAvail_2015B>();
            }
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "")
        public static class BookingClassAvail_2015B {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StopLocation_2015B {
