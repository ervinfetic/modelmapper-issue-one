...
public class VehicleAvailRSCoreType_2015B {
    ...
    protected VehicleAvailRSCoreType_2015B.VehVendorAvails_2015B vehVendorAvails;
     ...
     * @return
     *     possible object is
     *     {@link VehicleAvailRSCoreType_2015B.VehVendorAvails_2015B }
     *     
     */
    public VehicleAvailRSCoreType_2015B.VehVendorAvails_2015B getVehVendorAvails() {
     ...
     *     
     */
    public void setVehVendorAvails(VehicleAvailRSCoreType_2015B.VehVendorAvails_2015B value) {
    ...
    public static class VehVendorAvails_2015B {

        @XmlElement(name = "VehVendorAvail", required = true)
        protected List<VehicleVendorAvailabilityType_2015B> vehVendorAvail;
         ...
         * {@link VehicleVendorAvailabilityType_2015B }
         * 
         * 
         */
        public List<VehicleVendorAvailabilityType_2015B> getVehVendorAvail() {
            if (vehVendorAvail == null) {
                vehVendorAvail = new ArrayList<VehicleVendorAvailabilityType_2015B>();
            }
