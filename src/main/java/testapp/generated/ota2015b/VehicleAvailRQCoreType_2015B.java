...
public class VehicleAvailRQCoreType_2015B {
    ...
    protected MultiModalOfferType_2015B multimodalOffer;
    @XmlElement(name = "VendorPrefs")
    protected VehicleAvailRQCoreType_2015B.VendorPrefs_2015B vendorPrefs;
    @XmlElement(name = "VehPrefs")
    protected VehicleAvailRQCoreType_2015B.VehPrefs_2015B vehPrefs;
    @XmlElement(name = "DriverType")
    protected List<VehicleAvailRQCoreType_2015B.DriverType_2015B> driverType;
    @XmlElement(name = "RateQualifier")
    protected List<VehicleAvailRQCoreType_2015B.RateQualifier_2015B> rateQualifier;
    @XmlElement(name = "RateRange")
    protected VehicleAvailRQCoreType_2015B.RateRange_2015B rateRange;
    @XmlElement(name = "SpecialEquipPrefs")
    protected VehicleAvailRQCoreType_2015B.SpecialEquipPrefs_2015B specialEquipPrefs;
     ...
     * @return
     *     possible object is
     *     {@link MultiModalOfferType_2015B }
     *     
     */
    public MultiModalOfferType_2015B getMultimodalOffer() {
     ...
     *     
     */
    public void setMultimodalOffer(MultiModalOfferType_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link VehicleAvailRQCoreType_2015B.VendorPrefs_2015B }
     *     
     */
    public VehicleAvailRQCoreType_2015B.VendorPrefs_2015B getVendorPrefs() {
        return vendorPrefs;
    }
     ...
     *     
     */
    public void setVendorPrefs(VehicleAvailRQCoreType_2015B.VendorPrefs_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link VehicleAvailRQCoreType_2015B.VehPrefs_2015B }
     *     
     */
    public VehicleAvailRQCoreType_2015B.VehPrefs_2015B getVehPrefs() {
        return vehPrefs;
    }
     ...
     *     
     */
    public void setVehPrefs(VehicleAvailRQCoreType_2015B.VehPrefs_2015B value) {
        this.vehPrefs = value;
    }
     ...
     * {@link VehicleAvailRQCoreType_2015B.DriverType_2015B }
     * 
     * 
     */
    public List<VehicleAvailRQCoreType_2015B.DriverType_2015B> getDriverType() {
        if (driverType == null) {
            driverType = new ArrayList<VehicleAvailRQCoreType_2015B.DriverType_2015B>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link VehicleAvailRQCoreType_2015B.RateQualifier_2015B }
     * 
     * 
     */
    public List<VehicleAvailRQCoreType_2015B.RateQualifier_2015B> getRateQualifier() {
        if (rateQualifier == null) {
            rateQualifier = new ArrayList<VehicleAvailRQCoreType_2015B.RateQualifier_2015B>();
        }
     ...
     * @return
     *     possible object is
     *     {@link VehicleAvailRQCoreType_2015B.RateRange_2015B }
     *     
     */
    public VehicleAvailRQCoreType_2015B.RateRange_2015B getRateRange() {
        return rateRange;
    }
     ...
     *     
     */
    public void setRateRange(VehicleAvailRQCoreType_2015B.RateRange_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link VehicleAvailRQCoreType_2015B.SpecialEquipPrefs_2015B }
     *     
     */
    public VehicleAvailRQCoreType_2015B.SpecialEquipPrefs_2015B getSpecialEquipPrefs() {
     ...
     *     
     */
    public void setSpecialEquipPrefs(VehicleAvailRQCoreType_2015B.SpecialEquipPrefs_2015B value) {
    ...
    public static class SpecialEquipPrefs_2015B {
        ...
        protected List<VehicleAvailRQCoreType_2015B.SpecialEquipPrefs_2015B.SpecialEquipPref_2015B> specialEquipPref;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link VehicleAvailRQCoreType_2015B.SpecialEquipPrefs_2015B.SpecialEquipPref_2015B }
         * 
         * 
         */
        public List<VehicleAvailRQCoreType_2015B.SpecialEquipPrefs_2015B.SpecialEquipPref_2015B> getSpecialEquipPref() {
            if (specialEquipPref == null) {
                specialEquipPref = new ArrayList<VehicleAvailRQCoreType_2015B.SpecialEquipPrefs_2015B.SpecialEquipPref_2015B>();
            }
    ...
    public static class VehPrefs_2015B {

        @XmlElement(name = "VehPref", required = true)
        protected List<VehicleAvailRQCoreType_2015B.VehPrefs_2015B.VehPref_2015B> vehPref;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link VehicleAvailRQCoreType_2015B.VehPrefs_2015B.VehPref_2015B }
         * 
         * 
         */
        public List<VehicleAvailRQCoreType_2015B.VehPrefs_2015B.VehPref_2015B> getVehPref() {
            if (vehPref == null) {
                vehPref = new ArrayList<VehicleAvailRQCoreType_2015B.VehPrefs_2015B.VehPref_2015B>();
            }
            return this.vehPref;
        }
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "")
        public static class VehPref_2015B
            extends VehiclePrefType_2015B
        {
    ...
    public static class VendorPrefs_2015B {

        @XmlElement(name = "VendorPref", required = true)
        protected List<VehicleAvailRQCoreType_2015B.VendorPrefs_2015B.VendorPref_2015B> vendorPref;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link VehicleAvailRQCoreType_2015B.VendorPrefs_2015B.VendorPref_2015B }
         * 
         * 
         */
        public List<VehicleAvailRQCoreType_2015B.VendorPrefs_2015B.VendorPref_2015B> getVendorPref() {
            if (vendorPref == null) {
                vendorPref = new ArrayList<VehicleAvailRQCoreType_2015B.VendorPrefs_2015B.VendorPref_2015B>();
            }
