...
@XmlEnum
public enum FareAccessPrefType_2015B {
    ...
    FareAccessPrefType_2015B(String v) {
        value = v;
    }
    ...
    public static FareAccessPrefType_2015B fromValue(String v) {
        for (FareAccessPrefType_2015B c: FareAccessPrefType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
