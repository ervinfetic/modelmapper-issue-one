...
public class SpecialRequestType_2015B {

    @XmlElement(name = "SpecialRequest", required = true)
    protected List<SpecialRequestType_2015B.SpecialRequest_2015B> specialRequest;
     ...
     * {@link SpecialRequestType_2015B.SpecialRequest_2015B }
     * 
     * 
     */
    public List<SpecialRequestType_2015B.SpecialRequest_2015B> getSpecialRequest() {
        if (specialRequest == null) {
            specialRequest = new ArrayList<SpecialRequestType_2015B.SpecialRequest_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class SpecialRequest_2015B
