...
@XmlEnum
public enum ListLevelOfServiceBase_2015B {
    ...
    ListLevelOfServiceBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListLevelOfServiceBase_2015B fromValue(String v) {
        for (ListLevelOfServiceBase_2015B c: ListLevelOfServiceBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
