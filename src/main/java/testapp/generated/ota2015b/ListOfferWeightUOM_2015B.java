...
@XmlEnum
public enum ListOfferWeightUOM_2015B {
    ...
    ListOfferWeightUOM_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferWeightUOM_2015B fromValue(String v) {
        for (ListOfferWeightUOM_2015B c: ListOfferWeightUOM_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
