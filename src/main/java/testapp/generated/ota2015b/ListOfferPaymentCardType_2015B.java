...
@XmlEnum
public enum ListOfferPaymentCardType_2015B {
    ...
    ListOfferPaymentCardType_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferPaymentCardType_2015B fromValue(String v) {
        for (ListOfferPaymentCardType_2015B c: ListOfferPaymentCardType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
