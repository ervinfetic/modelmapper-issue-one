...
@XmlEnum
public enum ListOfferDistanceUOM_2015B {
    ...
    ListOfferDistanceUOM_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferDistanceUOM_2015B fromValue(String v) {
        for (ListOfferDistanceUOM_2015B c: ListOfferDistanceUOM_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
