...
@XmlEnum
public enum OnLocationServiceIDType_2015B {
    ...
    OnLocationServiceIDType_2015B(String v) {
        value = v;
    }
    ...
    public static OnLocationServiceIDType_2015B fromValue(String v) {
        for (OnLocationServiceIDType_2015B c: OnLocationServiceIDType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
