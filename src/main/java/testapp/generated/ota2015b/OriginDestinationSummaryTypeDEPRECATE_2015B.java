...
public class OriginDestinationSummaryTypeDEPRECATE_2015B {
    ...
    protected List<TrainInfoType_2015B> trainInfo;
     ...
     * 
     */
    public List<TrainInfoType_2015B> getTrainInfo() {
        if (trainInfo == null) {
            trainInfo = new ArrayList<TrainInfoType_2015B>();
        }
