...
public class HotelSearchCriteriaType_2015B {

    @XmlElement(name = "Criterion", required = true)
    protected List<HotelSearchCriteriaType_2015B.Criterion_2015B> criterion;
     ...
     * {@link HotelSearchCriteriaType_2015B.Criterion_2015B }
     * 
     * 
     */
    public List<HotelSearchCriteriaType_2015B.Criterion_2015B> getCriterion() {
        if (criterion == null) {
            criterion = new ArrayList<HotelSearchCriteriaType_2015B.Criterion_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class Criterion_2015B
        extends HotelSearchCriterionType_2015B
    {
