...
@XmlEnum
public enum CoverageTextType_2015B {
    ...
    CoverageTextType_2015B(String v) {
        value = v;
    }
    ...
    public static CoverageTextType_2015B fromValue(String v) {
        for (CoverageTextType_2015B c: CoverageTextType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
