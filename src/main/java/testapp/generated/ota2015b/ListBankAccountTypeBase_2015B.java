...
@XmlEnum
public enum ListBankAccountTypeBase_2015B {
    ...
    ListBankAccountTypeBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListBankAccountTypeBase_2015B fromValue(String v) {
        for (ListBankAccountTypeBase_2015B c: ListBankAccountTypeBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
