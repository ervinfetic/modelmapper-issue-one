...
@XmlSeeAlso({
    testapp.generated.ota2015b.EMDType_2015B.FareInfo_2015B.class
})
public class ETFareInfo_2015B {

    @XmlElement(name = "Waiver")
    protected List<ETFareInfo_2015B.Waiver_2015B> waiver;
    @XmlElement(name = "RuleIndicator")
    protected List<ETFareInfo_2015B.RuleIndicator_2015B> ruleIndicator;
     ...
     * {@link ETFareInfo_2015B.Waiver_2015B }
     * 
     * 
     */
    public List<ETFareInfo_2015B.Waiver_2015B> getWaiver() {
        if (waiver == null) {
            waiver = new ArrayList<ETFareInfo_2015B.Waiver_2015B>();
        }
        return this.waiver;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ETFareInfo_2015B.RuleIndicator_2015B }
     * 
     * 
     */
    public List<ETFareInfo_2015B.RuleIndicator_2015B> getRuleIndicator() {
        if (ruleIndicator == null) {
            ruleIndicator = new ArrayList<ETFareInfo_2015B.RuleIndicator_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class RuleIndicator_2015B {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class Waiver_2015B {
