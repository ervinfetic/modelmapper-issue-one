...
@XmlSeeAlso({
    testapp.generated.ota2015b.RestaurantType_2015B.MultimediaDescriptions_2015B.class
})
public class MultimediaDescriptionsType_2015B {

    @XmlElement(name = "MultimediaDescription", required = true)
    protected List<MultimediaDescriptionType_2015B> multimediaDescription;
     ...
     * {@link MultimediaDescriptionType_2015B }
     * 
     * 
     */
    public List<MultimediaDescriptionType_2015B> getMultimediaDescription() {
        if (multimediaDescription == null) {
            multimediaDescription = new ArrayList<MultimediaDescriptionType_2015B>();
        }
