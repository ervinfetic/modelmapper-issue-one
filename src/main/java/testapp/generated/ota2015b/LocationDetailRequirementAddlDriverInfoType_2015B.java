...
@XmlEnum
public enum LocationDetailRequirementAddlDriverInfoType_2015B {
    ...
    LocationDetailRequirementAddlDriverInfoType_2015B(String v) {
        value = v;
    }
    ...
    public static LocationDetailRequirementAddlDriverInfoType_2015B fromValue(String v) {
        for (LocationDetailRequirementAddlDriverInfoType_2015B c: LocationDetailRequirementAddlDriverInfoType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
