...
public class ServiceType_2015B {

    @XmlElement(name = "Price")
    protected List<AmountType_2015B> price;
    @XmlElement(name = "ServiceDetails")
    protected ServiceType_2015B.ServiceDetails_2015B serviceDetails;
    @XmlElement(name = "TPA_Extensions")
    protected TPAExtensionsType_2015B tpaExtensions;
    @XmlAttribute(name = "ServicePricingType")
    protected PricingType_2015B servicePricingType;
    @XmlAttribute(name = "ReservationStatusType")
    protected PMSResStatusType_2015B reservationStatusType;
     ...
     * {@link AmountType_2015B }
     * 
     * 
     */
    public List<AmountType_2015B> getPrice() {
        if (price == null) {
            price = new ArrayList<AmountType_2015B>();
        }
        return this.price;
    }
     ...
     * @return
     *     possible object is
     *     {@link ServiceType_2015B.ServiceDetails_2015B }
     *     
     */
    public ServiceType_2015B.ServiceDetails_2015B getServiceDetails() {
     ...
     *     
     */
    public void setServiceDetails(ServiceType_2015B.ServiceDetails_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link PricingType_2015B }
     *     
     */
    public PricingType_2015B getServicePricingType() {
     ...
     *     
     */
    public void setServicePricingType(PricingType_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link PMSResStatusType_2015B }
     *     
     */
    public PMSResStatusType_2015B getReservationStatusType() {
     ...
     *     
     */
    public void setReservationStatusType(PMSResStatusType_2015B value) {
    ...
    public static class ServiceDetails_2015B
        extends ResCommonDetailType_2015B
    {

        @XmlElement(name = "ServiceDescription")
        protected ParagraphType_2015B serviceDescription;
         ...
         *     
         */
        public ParagraphType_2015B getServiceDescription() {
         ...
         *     
         */
        public void setServiceDescription(ParagraphType_2015B value) {
