...
public class VideoItemsType_2015B {

    @XmlElement(name = "VideoItem", required = true)
    protected List<VideoItemsType_2015B.VideoItem_2015B> videoItem;
     ...
     * {@link VideoItemsType_2015B.VideoItem_2015B }
     * 
     * 
     */
    public List<VideoItemsType_2015B.VideoItem_2015B> getVideoItem() {
        if (videoItem == null) {
            videoItem = new ArrayList<VideoItemsType_2015B.VideoItem_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class VideoItem_2015B
        extends VideoDescriptionType_2015B
    {
