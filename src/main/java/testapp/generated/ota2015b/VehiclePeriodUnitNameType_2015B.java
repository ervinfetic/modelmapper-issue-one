...
@XmlEnum
public enum VehiclePeriodUnitNameType_2015B {
    ...
    VehiclePeriodUnitNameType_2015B(String v) {
        value = v;
    }
    ...
    public static VehiclePeriodUnitNameType_2015B fromValue(String v) {
        for (VehiclePeriodUnitNameType_2015B c: VehiclePeriodUnitNameType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
