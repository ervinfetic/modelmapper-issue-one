...
@XmlEnum
public enum ListOfferRateCategory_2015B {
    ...
    ListOfferRateCategory_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferRateCategory_2015B fromValue(String v) {
        for (ListOfferRateCategory_2015B c: ListOfferRateCategory_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
