...
@XmlEnum
public enum RateIndicatorType_2015B {
    ...
    RateIndicatorType_2015B(String v) {
        value = v;
    }
    ...
    public static RateIndicatorType_2015B fromValue(String v) {
        for (RateIndicatorType_2015B c: RateIndicatorType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
