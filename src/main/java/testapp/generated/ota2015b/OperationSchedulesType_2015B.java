...
public class OperationSchedulesType_2015B {

    @XmlElement(name = "OperationSchedule", required = true)
    protected List<OperationScheduleType_2015B> operationSchedule;
     ...
     * {@link OperationScheduleType_2015B }
     * 
     * 
     */
    public List<OperationScheduleType_2015B> getOperationSchedule() {
        if (operationSchedule == null) {
            operationSchedule = new ArrayList<OperationScheduleType_2015B>();
        }
