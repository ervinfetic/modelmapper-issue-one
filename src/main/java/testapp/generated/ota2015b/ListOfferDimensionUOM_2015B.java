...
@XmlEnum
public enum ListOfferDimensionUOM_2015B {
    ...
    ListOfferDimensionUOM_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferDimensionUOM_2015B fromValue(String v) {
        for (ListOfferDimensionUOM_2015B c: ListOfferDimensionUOM_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
