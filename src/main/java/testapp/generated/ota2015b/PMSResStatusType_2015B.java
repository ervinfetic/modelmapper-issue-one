...
@XmlEnum
public enum PMSResStatusType_2015B {
    ...
    PMSResStatusType_2015B(String v) {
        value = v;
    }
    ...
    public static PMSResStatusType_2015B fromValue(String v) {
        for (PMSResStatusType_2015B c: PMSResStatusType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
