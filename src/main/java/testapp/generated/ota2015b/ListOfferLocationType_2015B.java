...
@XmlEnum
public enum ListOfferLocationType_2015B {
    ...
    ListOfferLocationType_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferLocationType_2015B fromValue(String v) {
        for (ListOfferLocationType_2015B c: ListOfferLocationType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
