...
@XmlEnum
public enum ListOfferTripPurpose_2015B {
    ...
    ListOfferTripPurpose_2015B(String v) {
        value = v;
    }
    ...
    public static ListOfferTripPurpose_2015B fromValue(String v) {
        for (ListOfferTripPurpose_2015B c: ListOfferTripPurpose_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
