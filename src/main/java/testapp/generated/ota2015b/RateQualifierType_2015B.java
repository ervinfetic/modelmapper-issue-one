...
@XmlSeeAlso({
    testapp.generated.ota2015b.VehicleRentalRateType_2015B.RateQualifier_2015B.class
})
public class RateQualifierType_2015B {

    @XmlElement(name = "PromoDesc")
    protected String promoDesc;
    @XmlElement(name = "RateComments")
    protected RateQualifierType_2015B.RateComments_2015B rateComments;
     ...
     * @return
     *     possible object is
     *     {@link RateQualifierType_2015B.RateComments_2015B }
     *     
     */
    public RateQualifierType_2015B.RateComments_2015B getRateComments() {
        return rateComments;
    }
     ...
     *     
     */
    public void setRateComments(RateQualifierType_2015B.RateComments_2015B value) {
    ...
    public static class RateComments_2015B {

        @XmlElement(name = "RateComment", required = true)
        protected List<RateQualifierType_2015B.RateComments_2015B.RateComment_2015B> rateComment;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link RateQualifierType_2015B.RateComments_2015B.RateComment_2015B }
         * 
         * 
         */
        public List<RateQualifierType_2015B.RateComments_2015B.RateComment_2015B> getRateComment() {
            if (rateComment == null) {
                rateComment = new ArrayList<RateQualifierType_2015B.RateComments_2015B.RateComment_2015B>();
            }
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "")
        public static class RateComment_2015B
