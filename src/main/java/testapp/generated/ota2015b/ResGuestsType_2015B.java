...
public class ResGuestsType_2015B {

    @XmlElement(name = "ResGuest", required = true)
    protected List<ResGuestType_2015B> resGuest;
     ...
     * {@link ResGuestType_2015B }
     * 
     * 
     */
    public List<ResGuestType_2015B> getResGuest() {
        if (resGuest == null) {
            resGuest = new ArrayList<ResGuestType_2015B>();
        }
