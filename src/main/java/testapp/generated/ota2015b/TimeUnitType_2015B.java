...
@XmlEnum
public enum TimeUnitType_2015B {
    ...
    public static TimeUnitType_2015B fromValue(String v) {
        for (TimeUnitType_2015B c: TimeUnitType_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
