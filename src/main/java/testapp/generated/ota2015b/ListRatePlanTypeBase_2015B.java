...
@XmlEnum
public enum ListRatePlanTypeBase_2015B {
    ...
    ListRatePlanTypeBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListRatePlanTypeBase_2015B fromValue(String v) {
        for (ListRatePlanTypeBase_2015B c: ListRatePlanTypeBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
