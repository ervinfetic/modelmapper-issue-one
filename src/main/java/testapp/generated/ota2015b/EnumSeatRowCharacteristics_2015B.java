...
@XmlEnum
public enum EnumSeatRowCharacteristics_2015B {
    ...
    EnumSeatRowCharacteristics_2015B(String v) {
        value = v;
    }
    ...
    public static EnumSeatRowCharacteristics_2015B fromValue(String v) {
        for (EnumSeatRowCharacteristics_2015B c: EnumSeatRowCharacteristics_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
