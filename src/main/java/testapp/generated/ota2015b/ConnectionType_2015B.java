...
public class ConnectionType_2015B {

    @XmlElement(name = "ConnectionLocation", required = true)
    protected List<ConnectionType_2015B.ConnectionLocation_2015B> connectionLocation;
     ...
     * {@link ConnectionType_2015B.ConnectionLocation_2015B }
     * 
     * 
     */
    public List<ConnectionType_2015B.ConnectionLocation_2015B> getConnectionLocation() {
        if (connectionLocation == null) {
            connectionLocation = new ArrayList<ConnectionType_2015B.ConnectionLocation_2015B>();
        }
