...
@XmlEnum
public enum EnumSeatAvailability_2015B {
    ...
    EnumSeatAvailability_2015B(String v) {
        value = v;
    }
    ...
    public static EnumSeatAvailability_2015B fromValue(String v) {
        for (EnumSeatAvailability_2015B c: EnumSeatAvailability_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
