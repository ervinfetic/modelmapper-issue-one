...
@XmlEnum
public enum ListPowerTypeBase_2015B {
    ...
    ListPowerTypeBase_2015B(String v) {
        value = v;
    }
    ...
    public static ListPowerTypeBase_2015B fromValue(String v) {
        for (ListPowerTypeBase_2015B c: ListPowerTypeBase_2015B.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
