...
public class ImageItemsType_2015B {

    @XmlElement(name = "ImageItem", required = true)
    protected List<ImageItemsType_2015B.ImageItem_2015B> imageItem;
     ...
     * {@link ImageItemsType_2015B.ImageItem_2015B }
     * 
     * 
     */
    public List<ImageItemsType_2015B.ImageItem_2015B> getImageItem() {
        if (imageItem == null) {
            imageItem = new ArrayList<ImageItemsType_2015B.ImageItem_2015B>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class ImageItem_2015B
