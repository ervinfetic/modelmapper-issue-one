...
@XmlSeeAlso({
    testapp.generated.ota2015b.ResCommonDetailType_2015B.TimeSpan_2015B.class
})
public class DateTimeSpanType_2015B {

    @XmlElement(name = "DateWindowRange")
    protected TimeInstantType_2015B dateWindowRange;
    @XmlElement(name = "StartDateWindow")
    protected DateTimeSpanType_2015B.StartDateWindow_2015B startDateWindow;
    @XmlElement(name = "EndDateWindow")
    protected DateTimeSpanType_2015B.EndDateWindow_2015B endDateWindow;
     ...
     *     
     */
    public TimeInstantType_2015B getDateWindowRange() {
     ...
     *     
     */
    public void setDateWindowRange(TimeInstantType_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link DateTimeSpanType_2015B.StartDateWindow_2015B }
     *     
     */
    public DateTimeSpanType_2015B.StartDateWindow_2015B getStartDateWindow() {
     ...
     *     
     */
    public void setStartDateWindow(DateTimeSpanType_2015B.StartDateWindow_2015B value) {
     ...
     * @return
     *     possible object is
     *     {@link DateTimeSpanType_2015B.EndDateWindow_2015B }
     *     
     */
    public DateTimeSpanType_2015B.EndDateWindow_2015B getEndDateWindow() {
     ...
     *     
     */
    public void setEndDateWindow(DateTimeSpanType_2015B.EndDateWindow_2015B value) {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class EndDateWindow_2015B {
        ...
        protected DayOfWeekType_2015B dow;
         ...
         *     
         */
        public DayOfWeekType_2015B getDOW() {
            return dow;
        }
         ...
         *     
         */
        public void setDOW(DayOfWeekType_2015B value) {
            this.dow = value;
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StartDateWindow_2015B {
