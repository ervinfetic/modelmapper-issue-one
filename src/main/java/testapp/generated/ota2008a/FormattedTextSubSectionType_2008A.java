...
public class FormattedTextSubSectionType_2008A {

    @XmlElement(name = "Paragraph", required = true)
    protected List<ParagraphType_2008A> paragraph;
     ...
     * 
     */
    public List<ParagraphType_2008A> getParagraph() {
        if (paragraph == null) {
            paragraph = new ArrayList<ParagraphType_2008A>();
        }
