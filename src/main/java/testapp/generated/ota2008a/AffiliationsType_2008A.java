...
public class AffiliationsType_2008A {

    @XmlElement(name = "Organization")
    protected List<OrganizationType_2008A> organization;
    @XmlElement(name = "Employer")
    protected List<EmployerType_2008A> employer;
    @XmlElement(name = "TravelArranger")
    protected List<TravelArrangerType_2008A> travelArranger;
    @XmlElement(name = "TravelClub")
    protected List<TravelClubType_2008A> travelClub;
    @XmlElement(name = "Insurance")
    protected List<InsuranceType_2008A> insurance;
     ...
     * {@link OrganizationType_2008A }
     * 
     * 
     */
    public List<OrganizationType_2008A> getOrganization() {
        if (organization == null) {
            organization = new ArrayList<OrganizationType_2008A>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link EmployerType_2008A }
     * 
     * 
     */
    public List<EmployerType_2008A> getEmployer() {
        if (employer == null) {
            employer = new ArrayList<EmployerType_2008A>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TravelClubType_2008A }
     * 
     * 
     */
    public List<TravelClubType_2008A> getTravelClub() {
        if (travelClub == null) {
            travelClub = new ArrayList<TravelClubType_2008A>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InsuranceType_2008A }
     * 
     * 
     */
    public List<InsuranceType_2008A> getInsurance() {
        if (insurance == null) {
            insurance = new ArrayList<InsuranceType_2008A>();
        }
