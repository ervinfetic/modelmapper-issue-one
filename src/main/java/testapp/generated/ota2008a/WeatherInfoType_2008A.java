...
public class WeatherInfoType_2008A {

    @XmlElement(name = "Precipitation")
    protected List<WeatherInfoType_2008A.Precipitation_2008A> precipitation;
    @XmlElement(name = "Temperature")
    protected List<WeatherInfoType_2008A.Temperature_2008A> temperature;
     ...
     * {@link WeatherInfoType_2008A.Precipitation_2008A }
     * 
     * 
     */
    public List<WeatherInfoType_2008A.Precipitation_2008A> getPrecipitation() {
        if (precipitation == null) {
            precipitation = new ArrayList<WeatherInfoType_2008A.Precipitation_2008A>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link WeatherInfoType_2008A.Temperature_2008A }
     * 
     * 
     */
    public List<WeatherInfoType_2008A.Temperature_2008A> getTemperature() {
        if (temperature == null) {
            temperature = new ArrayList<WeatherInfoType_2008A.Temperature_2008A>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class Precipitation_2008A {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class Temperature_2008A {
