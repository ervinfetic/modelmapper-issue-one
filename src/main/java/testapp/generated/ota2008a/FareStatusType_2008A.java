...
@XmlEnum
public enum FareStatusType_2008A {
    ...
    public static FareStatusType_2008A fromValue(String v) {
        for (FareStatusType_2008A c: FareStatusType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
