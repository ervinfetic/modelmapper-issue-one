...
public class RevenueDetailsType_2008A {

    @XmlElement(name = "RevenueDetail", required = true)
    protected List<RevenueDetailType_2008A> revenueDetail;
     ...
     * {@link RevenueDetailType_2008A }
     * 
     * 
     */
    public List<RevenueDetailType_2008A> getRevenueDetail() {
        if (revenueDetail == null) {
            revenueDetail = new ArrayList<RevenueDetailType_2008A>();
        }
