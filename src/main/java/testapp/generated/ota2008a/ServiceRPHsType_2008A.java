...
public class ServiceRPHsType_2008A {

    @XmlElement(name = "ServiceRPH", required = true)
    protected List<ServiceRPHsType_2008A.ServiceRPH_2008A> serviceRPH;
     ...
     * {@link ServiceRPHsType_2008A.ServiceRPH_2008A }
     * 
     * 
     */
    public List<ServiceRPHsType_2008A.ServiceRPH_2008A> getServiceRPH() {
        if (serviceRPH == null) {
            serviceRPH = new ArrayList<ServiceRPHsType_2008A.ServiceRPH_2008A>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class ServiceRPH_2008A {
