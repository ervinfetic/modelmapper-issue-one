...
@XmlEnum
public enum LocationDetailRequirementInfoType_2008A {
    ...
    LocationDetailRequirementInfoType_2008A(String v) {
        value = v;
    }
    ...
    public static LocationDetailRequirementInfoType_2008A fromValue(String v) {
        for (LocationDetailRequirementInfoType_2008A c: LocationDetailRequirementInfoType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
