...
@XmlEnum
public enum LocationDetailShuttleInfoType_2008A {
    ...
    LocationDetailShuttleInfoType_2008A(String v) {
        value = v;
    }
    ...
    public static LocationDetailShuttleInfoType_2008A fromValue(String v) {
        for (LocationDetailShuttleInfoType_2008A c: LocationDetailShuttleInfoType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
