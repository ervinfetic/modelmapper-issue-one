...
@XmlEnum
public enum LocationDetailVehicleInfoType_2008A {
    ...
    LocationDetailVehicleInfoType_2008A(String v) {
        value = v;
    }
    ...
    public static LocationDetailVehicleInfoType_2008A fromValue(String v) {
        for (LocationDetailVehicleInfoType_2008A c: LocationDetailVehicleInfoType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
