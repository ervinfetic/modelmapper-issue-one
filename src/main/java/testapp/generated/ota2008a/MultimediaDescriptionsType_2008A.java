...
@XmlSeeAlso({
    testapp.generated.ota2008a.RestaurantType_2008A.MultimediaDescriptions_2008A.class
})
public class MultimediaDescriptionsType_2008A {

    @XmlElement(name = "MultimediaDescription", required = true)
    protected List<MultimediaDescriptionType_2008A> multimediaDescription;
     ...
     * {@link MultimediaDescriptionType_2008A }
     * 
     * 
     */
    public List<MultimediaDescriptionType_2008A> getMultimediaDescription() {
        if (multimediaDescription == null) {
            multimediaDescription = new ArrayList<MultimediaDescriptionType_2008A>();
        }
