...
@XmlEnum
public enum OnLocationServiceIDType_2008A {
    ...
    OnLocationServiceIDType_2008A(String v) {
        value = v;
    }
    ...
    public static OnLocationServiceIDType_2008A fromValue(String v) {
        for (OnLocationServiceIDType_2008A c: OnLocationServiceIDType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
