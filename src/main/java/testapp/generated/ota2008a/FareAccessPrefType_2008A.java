...
@XmlEnum
public enum FareAccessPrefType_2008A {
    ...
    FareAccessPrefType_2008A(String v) {
        value = v;
    }
    ...
    public static FareAccessPrefType_2008A fromValue(String v) {
        for (FareAccessPrefType_2008A c: FareAccessPrefType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
