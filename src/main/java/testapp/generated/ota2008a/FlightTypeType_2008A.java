...
@XmlEnum
public enum FlightTypeType_2008A {
    ...
    public static FlightTypeType_2008A fromValue(String v) {
        for (FlightTypeType_2008A c: FlightTypeType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
