...
@XmlEnum
public enum RatePeriodSimpleType_2008A {
    ...
    RatePeriodSimpleType_2008A(String v) {
        value = v;
    }
    ...
    public static RatePeriodSimpleType_2008A fromValue(String v) {
        for (RatePeriodSimpleType_2008A c: RatePeriodSimpleType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
