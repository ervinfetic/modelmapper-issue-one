...
public class StayInfosType_2008A {

    @XmlElement(name = "StayInfo", required = true)
    protected List<StayInfoType_2008A> stayInfo;
     ...
     * {@link StayInfoType_2008A }
     * 
     * 
     */
    public List<StayInfoType_2008A> getStayInfo() {
        if (stayInfo == null) {
            stayInfo = new ArrayList<StayInfoType_2008A>();
        }
