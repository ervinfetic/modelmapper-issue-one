...
public class VehicleLocationVehiclesType_2008A {

    @XmlElement(name = "VehicleInfos")
    protected VehicleLocationVehiclesType_2008A.VehicleInfos_2008A vehicleInfos;
    @XmlElement(name = "Vehicle")
    protected List<VehicleLocationVehiclesType_2008A.Vehicle_2008A> vehicle;
     ...
     * @return
     *     possible object is
     *     {@link VehicleLocationVehiclesType_2008A.VehicleInfos_2008A }
     *     
     */
    public VehicleLocationVehiclesType_2008A.VehicleInfos_2008A getVehicleInfos() {
        return vehicleInfos;
    }
     ...
     *     
     */
    public void setVehicleInfos(VehicleLocationVehiclesType_2008A.VehicleInfos_2008A value) {
     ...
     * {@link VehicleLocationVehiclesType_2008A.Vehicle_2008A }
     * 
     * 
     */
    public List<VehicleLocationVehiclesType_2008A.Vehicle_2008A> getVehicle() {
        if (vehicle == null) {
            vehicle = new ArrayList<VehicleLocationVehiclesType_2008A.Vehicle_2008A>();
        }
        return this.vehicle;
    }
    ...
    public static class VehicleInfos_2008A {

        @XmlElement(name = "VehicleInfo", required = true)
        protected List<VehicleLocationVehiclesType_2008A.VehicleInfos_2008A.VehicleInfo_2008A> vehicleInfo;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link VehicleLocationVehiclesType_2008A.VehicleInfos_2008A.VehicleInfo_2008A }
         * 
         * 
         */
        public List<VehicleLocationVehiclesType_2008A.VehicleInfos_2008A.VehicleInfo_2008A> getVehicleInfo() {
            if (vehicleInfo == null) {
                vehicleInfo = new ArrayList<VehicleLocationVehiclesType_2008A.VehicleInfos_2008A.VehicleInfo_2008A>();
            }
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "")
        public static class VehicleInfo_2008A
            extends FormattedTextType_2008A
        {

            @XmlAttribute(name = "Type", required = true)
            protected LocationDetailVehicleInfoType_2008A type;
             ...
             * @return
             *     possible object is
             *     {@link LocationDetailVehicleInfoType_2008A }
             *     
             */
            public LocationDetailVehicleInfoType_2008A getType() {
                return type;
            }
             ...
             *     
             */
            public void setType(LocationDetailVehicleInfoType_2008A value) {
                this.type = value;
            }
        ...
        extends VehicleType_2008A
    {
         ...
         * 
         */
        public List<FormattedTextType_2008A> getText() {
            if (text == null) {
                text = new ArrayList<FormattedTextType_2008A>();
            }
            return this.text;
        }
         ...
         *     
         */
        public DistanceUnitNameType_2008A getDistanceUnit() {
            return distanceUnit;
        }
         ...
         *     
         */
        public void setDistanceUnit(DistanceUnitNameType_2008A value) {
