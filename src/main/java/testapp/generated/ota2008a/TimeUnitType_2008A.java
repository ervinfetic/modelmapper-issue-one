...
@XmlEnum
public enum TimeUnitType_2008A {
    ...
    public static TimeUnitType_2008A fromValue(String v) {
        for (TimeUnitType_2008A c: TimeUnitType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
