...
public class TaxType_2008A {

    @XmlElement(name = "TaxDescription")
    protected List<ParagraphType_2008A> taxDescription;
     ...
     * 
     */
    public List<ParagraphType_2008A> getTaxDescription() {
        if (taxDescription == null) {
            taxDescription = new ArrayList<ParagraphType_2008A>();
        }
