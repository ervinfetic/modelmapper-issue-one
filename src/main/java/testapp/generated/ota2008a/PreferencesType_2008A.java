...
public class PreferencesType_2008A {

    @XmlElement(name = "PrefCollection", required = true)
    protected List<PreferencesType_2008A.PrefCollection_2008A> prefCollection;
     ...
     * {@link PreferencesType_2008A.PrefCollection_2008A }
     * 
     * 
     */
    public List<PreferencesType_2008A.PrefCollection_2008A> getPrefCollection() {
        if (prefCollection == null) {
            prefCollection = new ArrayList<PreferencesType_2008A.PrefCollection_2008A>();
        }
    ...
    public static class PrefCollection_2008A {

        @XmlElement(name = "CommonPref")
        protected List<CommonPrefType_2008A> commonPref;
        @XmlElement(name = "VehicleRentalPref")
        protected List<VehicleProfileRentalPrefType_2008A> vehicleRentalPref;
        @XmlElement(name = "AirlinePref")
        protected List<AirlinePrefType_2008A> airlinePref;
        @XmlElement(name = "HotelPref")
        protected List<HotelPrefType_2008A> hotelPref;
        @XmlElement(name = "OtherSrvcPref")
        protected List<OtherSrvcPrefType_2008A> otherSrvcPref;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link CommonPrefType_2008A }
         * 
         * 
         */
        public List<CommonPrefType_2008A> getCommonPref() {
            if (commonPref == null) {
                commonPref = new ArrayList<CommonPrefType_2008A>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link VehicleProfileRentalPrefType_2008A }
         * 
         * 
         */
        public List<VehicleProfileRentalPrefType_2008A> getVehicleRentalPref() {
            if (vehicleRentalPref == null) {
                vehicleRentalPref = new ArrayList<VehicleProfileRentalPrefType_2008A>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link AirlinePrefType_2008A }
         * 
         * 
         */
        public List<AirlinePrefType_2008A> getAirlinePref() {
            if (airlinePref == null) {
                airlinePref = new ArrayList<AirlinePrefType_2008A>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link HotelPrefType_2008A }
         * 
         * 
         */
        public List<HotelPrefType_2008A> getHotelPref() {
            if (hotelPref == null) {
                hotelPref = new ArrayList<HotelPrefType_2008A>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link OtherSrvcPrefType_2008A }
         * 
         * 
         */
        public List<OtherSrvcPrefType_2008A> getOtherSrvcPref() {
            if (otherSrvcPref == null) {
                otherSrvcPref = new ArrayList<OtherSrvcPrefType_2008A>();
            }
