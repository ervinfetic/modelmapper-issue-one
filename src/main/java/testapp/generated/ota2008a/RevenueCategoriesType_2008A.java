...
public class RevenueCategoriesType_2008A {

    @XmlElement(name = "RevenueCategory", required = true)
    protected List<RevenueCategoryType_2008A> revenueCategory;
     ...
     * {@link RevenueCategoryType_2008A }
     * 
     * 
     */
    public List<RevenueCategoryType_2008A> getRevenueCategory() {
        if (revenueCategory == null) {
            revenueCategory = new ArrayList<RevenueCategoryType_2008A>();
        }
