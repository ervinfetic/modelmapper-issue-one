...
public class VideoItemsType_2008A {

    @XmlElement(name = "VideoItem", required = true)
    protected List<VideoItemsType_2008A.VideoItem_2008A> videoItem;
     ...
     * {@link VideoItemsType_2008A.VideoItem_2008A }
     * 
     * 
     */
    public List<VideoItemsType_2008A.VideoItem_2008A> getVideoItem() {
        if (videoItem == null) {
            videoItem = new ArrayList<VideoItemsType_2008A.VideoItem_2008A>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class VideoItem_2008A
        extends VideoDescriptionType_2008A
    {
