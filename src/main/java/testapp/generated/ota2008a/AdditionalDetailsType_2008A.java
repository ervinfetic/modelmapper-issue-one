...
public class AdditionalDetailsType_2008A {

    @XmlElement(name = "AdditionalDetail", required = true)
    protected List<AdditionalDetailType_2008A> additionalDetail;
     ...
     * {@link AdditionalDetailType_2008A }
     * 
     * 
     */
    public List<AdditionalDetailType_2008A> getAdditionalDetail() {
        if (additionalDetail == null) {
            additionalDetail = new ArrayList<AdditionalDetailType_2008A>();
        }
