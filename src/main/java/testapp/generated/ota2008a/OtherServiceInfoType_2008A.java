...
@XmlSeeAlso({
    testapp.generated.ota2008a.SpecialReqDetailsType_2008A.OtherServiceInformations_2008A.OtherServiceInformation_2008A.class
})
public class OtherServiceInfoType_2008A {

    @XmlElement(name = "TravelerRefNumber")
    protected List<OtherServiceInfoType_2008A.TravelerRefNumber_2008A> travelerRefNumber;
    @XmlElement(name = "Airline", required = true)
    protected CompanyNameType_2008A airline;
     ...
     * {@link OtherServiceInfoType_2008A.TravelerRefNumber_2008A }
     * 
     * 
     */
    public List<OtherServiceInfoType_2008A.TravelerRefNumber_2008A> getTravelerRefNumber() {
        if (travelerRefNumber == null) {
            travelerRefNumber = new ArrayList<OtherServiceInfoType_2008A.TravelerRefNumber_2008A>();
        }
     ...
     *     
     */
    public CompanyNameType_2008A getAirline() {
        return airline;
    }
     ...
     *     
     */
    public void setAirline(CompanyNameType_2008A value) {
        this.airline = value;
    }
