...
@XmlSeeAlso({
    BookingPriceInfoType_2008A.class
})
public class AirItineraryPricingInfoType_2008A {

    @XmlElement(name = "ItinTotalFare")
    protected List<AirItineraryPricingInfoType_2008A.ItinTotalFare_2008A> itinTotalFare;
    @XmlElement(name = "PTC_FareBreakdowns")
    protected AirItineraryPricingInfoType_2008A.PTCFareBreakdowns_2008A ptcFareBreakdowns;
    @XmlElement(name = "FareInfos")
    protected AirItineraryPricingInfoType_2008A.FareInfos_2008A fareInfos;
     ...
     * {@link AirItineraryPricingInfoType_2008A.ItinTotalFare_2008A }
     * 
     * 
     */
    public List<AirItineraryPricingInfoType_2008A.ItinTotalFare_2008A> getItinTotalFare() {
        if (itinTotalFare == null) {
            itinTotalFare = new ArrayList<AirItineraryPricingInfoType_2008A.ItinTotalFare_2008A>();
        }
     ...
     * @return
     *     possible object is
     *     {@link AirItineraryPricingInfoType_2008A.PTCFareBreakdowns_2008A }
     *     
     */
    public AirItineraryPricingInfoType_2008A.PTCFareBreakdowns_2008A getPTCFareBreakdowns() {
     ...
     *     
     */
    public void setPTCFareBreakdowns(AirItineraryPricingInfoType_2008A.PTCFareBreakdowns_2008A value) {
     ...
     * @return
     *     possible object is
     *     {@link AirItineraryPricingInfoType_2008A.FareInfos_2008A }
     *     
     */
    public AirItineraryPricingInfoType_2008A.FareInfos_2008A getFareInfos() {
        return fareInfos;
    }
     ...
     *     
     */
    public void setFareInfos(AirItineraryPricingInfoType_2008A.FareInfos_2008A value) {
    ...
    public static class FareInfos_2008A {

        @XmlElement(name = "FareInfo", required = true)
        protected List<AirItineraryPricingInfoType_2008A.FareInfos_2008A.FareInfo_2008A> fareInfo;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link AirItineraryPricingInfoType_2008A.FareInfos_2008A.FareInfo_2008A }
         * 
         * 
         */
        public List<AirItineraryPricingInfoType_2008A.FareInfos_2008A.FareInfo_2008A> getFareInfo() {
            if (fareInfo == null) {
                fareInfo = new ArrayList<AirItineraryPricingInfoType_2008A.FareInfos_2008A.FareInfo_2008A>();
            }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class ItinTotalFare_2008A
    ...
    public static class PTCFareBreakdowns_2008A {

        @XmlElement(name = "PTC_FareBreakdown", required = true)
        protected List<PTCFareBreakdownType_2008A> ptcFareBreakdown;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link PTCFareBreakdownType_2008A }
         * 
         * 
         */
        public List<PTCFareBreakdownType_2008A> getPTCFareBreakdown() {
            if (ptcFareBreakdown == null) {
                ptcFareBreakdown = new ArrayList<PTCFareBreakdownType_2008A>();
            }
