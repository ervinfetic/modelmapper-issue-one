...
@XmlEnum
public enum RateIndicatorType_2008A {
    ...
    RateIndicatorType_2008A(String v) {
        value = v;
    }
    ...
    public static RateIndicatorType_2008A fromValue(String v) {
        for (RateIndicatorType_2008A c: RateIndicatorType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
