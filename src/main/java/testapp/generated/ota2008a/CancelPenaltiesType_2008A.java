...
public class CancelPenaltiesType_2008A {

    @XmlElement(name = "CancelPenalty")
    protected List<CancelPenaltyType_2008A> cancelPenalty;
     ...
     * {@link CancelPenaltyType_2008A }
     * 
     * 
     */
    public List<CancelPenaltyType_2008A> getCancelPenalty() {
        if (cancelPenalty == null) {
            cancelPenalty = new ArrayList<CancelPenaltyType_2008A>();
        }
