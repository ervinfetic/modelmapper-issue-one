...
@XmlSeeAlso({
    testapp.generated.ota2008a.TravelerInfoSummaryType_2008A.PriceRequestInformation_2008A.class
})
public class PriceRequestInformationType_2008A {

    @XmlElement(name = "NegotiatedFareCode")
    protected List<PriceRequestInformationType_2008A.NegotiatedFareCode_2008A> negotiatedFareCode;
    @XmlElement(name = "RebookOption")
    protected List<PriceRequestInformationType_2008A.RebookOption_2008A> rebookOption;
     ...
     * {@link PriceRequestInformationType_2008A.NegotiatedFareCode_2008A }
     * 
     * 
     */
    public List<PriceRequestInformationType_2008A.NegotiatedFareCode_2008A> getNegotiatedFareCode() {
        if (negotiatedFareCode == null) {
            negotiatedFareCode = new ArrayList<PriceRequestInformationType_2008A.NegotiatedFareCode_2008A>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PriceRequestInformationType_2008A.RebookOption_2008A }
     * 
     * 
     */
    public List<PriceRequestInformationType_2008A.RebookOption_2008A> getRebookOption() {
        if (rebookOption == null) {
            rebookOption = new ArrayList<PriceRequestInformationType_2008A.RebookOption_2008A>();
        }
    ...
    public static class NegotiatedFareCode_2008A {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class RebookOption_2008A {
