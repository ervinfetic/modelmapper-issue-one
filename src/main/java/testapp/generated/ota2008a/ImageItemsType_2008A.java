...
public class ImageItemsType_2008A {

    @XmlElement(name = "ImageItem", required = true)
    protected List<ImageItemsType_2008A.ImageItem_2008A> imageItem;
     ...
     * {@link ImageItemsType_2008A.ImageItem_2008A }
     * 
     * 
     */
    public List<ImageItemsType_2008A.ImageItem_2008A> getImageItem() {
        if (imageItem == null) {
            imageItem = new ArrayList<ImageItemsType_2008A.ImageItem_2008A>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class ImageItem_2008A
        extends ImageDescriptionType_2008A
    {
