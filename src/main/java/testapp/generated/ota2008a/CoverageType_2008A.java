...
public class CoverageType_2008A {

    @XmlElement(name = "Details")
    protected List<CoverageDetailsType_2008A> details;
     ...
     * {@link CoverageDetailsType_2008A }
     * 
     * 
     */
    public List<CoverageDetailsType_2008A> getDetails() {
        if (details == null) {
            details = new ArrayList<CoverageDetailsType_2008A>();
        }
        return this.details;
    }
