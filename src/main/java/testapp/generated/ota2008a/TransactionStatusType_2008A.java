...
@XmlEnum
public enum TransactionStatusType_2008A {
    ...
    TransactionStatusType_2008A(String v) {
        value = v;
    }
    ...
    public static TransactionStatusType_2008A fromValue(String v) {
        for (TransactionStatusType_2008A c: TransactionStatusType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
