...
public class POSType_2008A {

    @XmlElement(name = "Source", required = true)
    protected List<SourceType_2008A> source;
     ...
     * {@link SourceType_2008A }
     * 
     * 
     */
    public List<SourceType_2008A> getSource() {
        if (source == null) {
            source = new ArrayList<SourceType_2008A>();
        }
        return this.source;
    }
