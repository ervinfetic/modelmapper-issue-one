...
public class LoyaltyPointsAccrualsType_2008A {

    @XmlElement(name = "SelectedLoyalty", required = true)
    protected List<LoyaltyPointsAccrualsType_2008A.SelectedLoyalty_2008A> selectedLoyalty;
     ...
     * {@link LoyaltyPointsAccrualsType_2008A.SelectedLoyalty_2008A }
     * 
     * 
     */
    public List<LoyaltyPointsAccrualsType_2008A.SelectedLoyalty_2008A> getSelectedLoyalty() {
        if (selectedLoyalty == null) {
            selectedLoyalty = new ArrayList<LoyaltyPointsAccrualsType_2008A.SelectedLoyalty_2008A>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class SelectedLoyalty_2008A {
