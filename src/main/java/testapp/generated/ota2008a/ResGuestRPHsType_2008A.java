...
public class ResGuestRPHsType_2008A {

    @XmlElement(name = "ResGuestRPH", required = true)
    protected List<ResGuestRPHsType_2008A.ResGuestRPH_2008A> resGuestRPH;
     ...
     * {@link ResGuestRPHsType_2008A.ResGuestRPH_2008A }
     * 
     * 
     */
    public List<ResGuestRPHsType_2008A.ResGuestRPH_2008A> getResGuestRPH() {
        if (resGuestRPH == null) {
            resGuestRPH = new ArrayList<ResGuestRPHsType_2008A.ResGuestRPH_2008A>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class ResGuestRPH_2008A {
