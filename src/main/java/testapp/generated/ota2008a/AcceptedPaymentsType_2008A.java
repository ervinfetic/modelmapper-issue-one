...
public class AcceptedPaymentsType_2008A {

    @XmlElement(name = "AcceptedPayment", required = true)
    protected List<PaymentFormType_2008A> acceptedPayment;
     ...
     * 
     */
    public List<PaymentFormType_2008A> getAcceptedPayment() {
        if (acceptedPayment == null) {
            acceptedPayment = new ArrayList<PaymentFormType_2008A>();
        }
