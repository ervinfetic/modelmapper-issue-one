...
public class PricedItinerariesType_2008A {

    @XmlElement(name = "PricedItinerary", required = true)
    protected List<PricedItinerariesType_2008A.PricedItinerary_2008A> pricedItinerary;
     ...
     * {@link PricedItinerariesType_2008A.PricedItinerary_2008A }
     * 
     * 
     */
    public List<PricedItinerariesType_2008A.PricedItinerary_2008A> getPricedItinerary() {
        if (pricedItinerary == null) {
            pricedItinerary = new ArrayList<PricedItinerariesType_2008A.PricedItinerary_2008A>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class PricedItinerary_2008A
        extends PricedItineraryType_2008A
    {
