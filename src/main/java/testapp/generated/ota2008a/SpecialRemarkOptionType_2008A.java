...
@XmlEnum
public enum SpecialRemarkOptionType_2008A {
    ...
    SpecialRemarkOptionType_2008A(String v) {
        value = v;
    }
    ...
    public static SpecialRemarkOptionType_2008A fromValue(String v) {
        for (SpecialRemarkOptionType_2008A c: SpecialRemarkOptionType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
