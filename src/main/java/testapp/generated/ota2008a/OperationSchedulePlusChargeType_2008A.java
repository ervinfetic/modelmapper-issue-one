...
@XmlSeeAlso({
    testapp.generated.ota2008a.OperationSchedulesPlusChargeType_2008A.OperationSchedule_2008A.class
})
public class OperationSchedulePlusChargeType_2008A
    extends OperationScheduleType_2008A
{

    @XmlElement(name = "Charge")
    protected List<FeeType_2008A> charge;
     ...
     * 
     */
    public List<FeeType_2008A> getCharge() {
        if (charge == null) {
            charge = new ArrayList<FeeType_2008A>();
        }
        return this.charge;
    }
