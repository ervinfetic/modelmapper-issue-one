...
@XmlEnum
public enum LocationDetailRequirementAddlDriverInfoType_2008A {
    ...
    LocationDetailRequirementAddlDriverInfoType_2008A(String v) {
        value = v;
    }
    ...
    public static LocationDetailRequirementAddlDriverInfoType_2008A fromValue(String v) {
        for (LocationDetailRequirementAddlDriverInfoType_2008A c: LocationDetailRequirementAddlDriverInfoType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
