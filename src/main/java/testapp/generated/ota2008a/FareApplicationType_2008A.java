...
@XmlEnum
public enum FareApplicationType_2008A {
    ...
    FareApplicationType_2008A(String v) {
        value = v;
    }
    ...
    public static FareApplicationType_2008A fromValue(String v) {
        for (FareApplicationType_2008A c: FareApplicationType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
