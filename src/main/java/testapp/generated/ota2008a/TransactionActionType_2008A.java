...
@XmlEnum
public enum TransactionActionType_2008A {
    ...
    TransactionActionType_2008A(String v) {
        value = v;
    }
    ...
    public static TransactionActionType_2008A fromValue(String v) {
        for (TransactionActionType_2008A c: TransactionActionType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
