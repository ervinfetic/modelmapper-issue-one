...
public class RowDetailsType_2008A {

    @XmlElement(name = "AirSeats", required = true)
    protected RowDetailsType_2008A.AirSeats_2008A airSeats;
    @XmlElement(name = "AirRowCharacteristics", required = true)
    protected RowDetailsType_2008A.AirRowCharacteristics_2008A airRowCharacteristics;
     ...
     * @return
     *     possible object is
     *     {@link RowDetailsType_2008A.AirSeats_2008A }
     *     
     */
    public RowDetailsType_2008A.AirSeats_2008A getAirSeats() {
        return airSeats;
    }
     ...
     *     
     */
    public void setAirSeats(RowDetailsType_2008A.AirSeats_2008A value) {
        this.airSeats = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link RowDetailsType_2008A.AirRowCharacteristics_2008A }
     *     
     */
    public RowDetailsType_2008A.AirRowCharacteristics_2008A getAirRowCharacteristics() {
     ...
     *     
     */
    public void setAirRowCharacteristics(RowDetailsType_2008A.AirRowCharacteristics_2008A value) {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class AirRowCharacteristics_2008A {
    ...
    public static class AirSeats_2008A {

        @XmlElement(name = "AirSeat", required = true)
        protected List<RowDetailsType_2008A.AirSeats_2008A.AirSeat_2008A> airSeat;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link RowDetailsType_2008A.AirSeats_2008A.AirSeat_2008A }
         * 
         * 
         */
        public List<RowDetailsType_2008A.AirSeats_2008A.AirSeat_2008A> getAirSeat() {
            if (airSeat == null) {
                airSeat = new ArrayList<RowDetailsType_2008A.AirSeats_2008A.AirSeat_2008A>();
            }
            return this.airSeat;
        }
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "")
        public static class AirSeat_2008A {
