...
public enum AirTripType_2008A {
    ...
    public static AirTripType_2008A fromValue(String v) {
        for (AirTripType_2008A c: AirTripType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
