...
public class HotelSearchCriteriaType_2008A {

    @XmlElement(name = "Criterion", required = true)
    protected List<HotelSearchCriteriaType_2008A.Criterion_2008A> criterion;
     ...
     * {@link HotelSearchCriteriaType_2008A.Criterion_2008A }
     * 
     * 
     */
    public List<HotelSearchCriteriaType_2008A.Criterion_2008A> getCriterion() {
        if (criterion == null) {
            criterion = new ArrayList<HotelSearchCriteriaType_2008A.Criterion_2008A>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class Criterion_2008A
        extends HotelSearchCriterionType_2008A
    {
