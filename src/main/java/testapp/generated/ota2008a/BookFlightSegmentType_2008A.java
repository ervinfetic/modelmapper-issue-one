...
@XmlSeeAlso({
    testapp.generated.ota2008a.PTCFareBreakdownType_2008A.PricingUnit_2008A.FareComponent_2008A.FlightLeg_2008A.class,
    testapp.generated.ota2008a.OriginDestinationOptionType_2008A.FlightSegment_2008A.class
})
public class BookFlightSegmentType_2008A
    extends FlightSegmentType_2008A
{

    @XmlElement(name = "MarriageGrp")
    protected String marriageGrp;
    @XmlElement(name = "BookingClassAvails")
    protected BookFlightSegmentType_2008A.BookingClassAvails_2008A bookingClassAvails;
    @XmlElement(name = "Comment")
    protected List<FreeTextType_2008A> comment;
    @XmlElement(name = "StopLocation")
    protected List<BookFlightSegmentType_2008A.StopLocation_2008A> stopLocation;
    ...
    protected DayOfWeekType_2008A departureDay;
     ...
     * @return
     *     possible object is
     *     {@link BookFlightSegmentType_2008A.BookingClassAvails_2008A }
     *     
     */
    public BookFlightSegmentType_2008A.BookingClassAvails_2008A getBookingClassAvails() {
     ...
     *     
     */
    public void setBookingClassAvails(BookFlightSegmentType_2008A.BookingClassAvails_2008A value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BookFlightSegmentType_2008A.StopLocation_2008A }
     * 
     * 
     */
    public List<BookFlightSegmentType_2008A.StopLocation_2008A> getStopLocation() {
        if (stopLocation == null) {
            stopLocation = new ArrayList<BookFlightSegmentType_2008A.StopLocation_2008A>();
        }
     ...
     *     
     */
    public DayOfWeekType_2008A getDepartureDay() {
        return departureDay;
    }
     ...
     *     
     */
    public void setDepartureDay(DayOfWeekType_2008A value) {
    ...
    public static class BookingClassAvails_2008A {

        @XmlElement(name = "BookingClassAvail", required = true)
        protected List<BookFlightSegmentType_2008A.BookingClassAvails_2008A.BookingClassAvail_2008A> bookingClassAvail;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link BookFlightSegmentType_2008A.BookingClassAvails_2008A.BookingClassAvail_2008A }
         * 
         * 
         */
        public List<BookFlightSegmentType_2008A.BookingClassAvails_2008A.BookingClassAvail_2008A> getBookingClassAvail() {
            if (bookingClassAvail == null) {
                bookingClassAvail = new ArrayList<BookFlightSegmentType_2008A.BookingClassAvails_2008A.BookingClassAvail_2008A>();
            }
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "")
        public static class BookingClassAvail_2008A {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class StopLocation_2008A {
