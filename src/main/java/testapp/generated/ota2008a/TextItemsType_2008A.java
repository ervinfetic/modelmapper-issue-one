...
public class TextItemsType_2008A {

    @XmlElement(name = "TextItem", required = true)
    protected List<TextItemsType_2008A.TextItem_2008A> textItem;
     ...
     * {@link TextItemsType_2008A.TextItem_2008A }
     * 
     * 
     */
    public List<TextItemsType_2008A.TextItem_2008A> getTextItem() {
        if (textItem == null) {
            textItem = new ArrayList<TextItemsType_2008A.TextItem_2008A>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class TextItem_2008A
        extends TextDescriptionType_2008A
    {
