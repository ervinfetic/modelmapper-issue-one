...
public class InvCountType_2008A {

    @XmlElement(name = "Inventory", required = true)
    protected List<BaseInvCountType_2008A> inventory;
     ...
     * {@link BaseInvCountType_2008A }
     * 
     * 
     */
    public List<BaseInvCountType_2008A> getInventory() {
        if (inventory == null) {
            inventory = new ArrayList<BaseInvCountType_2008A>();
        }
