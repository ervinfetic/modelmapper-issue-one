...
@XmlEnum
public enum VehicleFuelUnitNameType_2008A {
    ...
    VehicleFuelUnitNameType_2008A(String v) {
        value = v;
    }
    ...
    public static VehicleFuelUnitNameType_2008A fromValue(String v) {
        for (VehicleFuelUnitNameType_2008A c: VehicleFuelUnitNameType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
