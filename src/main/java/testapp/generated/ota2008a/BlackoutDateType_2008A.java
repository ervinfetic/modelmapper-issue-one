...
public class BlackoutDateType_2008A {

    @XmlElement(name = "BlackoutDate", required = true)
    protected List<DateTimeSpanType_2008A> blackoutDate;
     ...
     * 
     */
    public List<DateTimeSpanType_2008A> getBlackoutDate() {
        if (blackoutDate == null) {
            blackoutDate = new ArrayList<DateTimeSpanType_2008A>();
        }
