...
public class StatisticsType_2008A {

    @XmlElement(name = "Statistic", required = true)
    protected List<StatisticType_2008A> statistic;
     ...
     * {@link StatisticType_2008A }
     * 
     * 
     */
    public List<StatisticType_2008A> getStatistic() {
        if (statistic == null) {
            statistic = new ArrayList<StatisticType_2008A>();
        }
