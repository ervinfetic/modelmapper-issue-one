...
public class OperationSchedulesType_2008A {

    @XmlElement(name = "OperationSchedule", required = true)
    protected List<OperationScheduleType_2008A> operationSchedule;
     ...
     * {@link OperationScheduleType_2008A }
     * 
     * 
     */
    public List<OperationScheduleType_2008A> getOperationSchedule() {
        if (operationSchedule == null) {
            operationSchedule = new ArrayList<OperationScheduleType_2008A>();
        }
