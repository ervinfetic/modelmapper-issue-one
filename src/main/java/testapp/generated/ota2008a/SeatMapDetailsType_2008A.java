...
public class SeatMapDetailsType_2008A {

    @XmlElement(name = "CabinClass", required = true)
    protected List<SeatMapDetailsType_2008A.CabinClass_2008A> cabinClass;
     ...
     * {@link SeatMapDetailsType_2008A.CabinClass_2008A }
     * 
     * 
     */
    public List<SeatMapDetailsType_2008A.CabinClass_2008A> getCabinClass() {
        if (cabinClass == null) {
            cabinClass = new ArrayList<SeatMapDetailsType_2008A.CabinClass_2008A>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class CabinClass_2008A
        extends CabinClassType_2008A
    {
