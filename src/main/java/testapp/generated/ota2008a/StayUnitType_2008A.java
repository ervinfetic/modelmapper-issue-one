...
@XmlEnum
public enum StayUnitType_2008A {
    ...
    public static StayUnitType_2008A fromValue(String v) {
        for (StayUnitType_2008A c: StayUnitType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
