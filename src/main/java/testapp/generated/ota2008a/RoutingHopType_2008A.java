...
public class RoutingHopType_2008A {

    @XmlElement(name = "RoutingHop", required = true)
    protected List<RoutingHopType_2008A.RoutingHop_2008A> routingHop;
     ...
     * {@link RoutingHopType_2008A.RoutingHop_2008A }
     * 
     * 
     */
    public List<RoutingHopType_2008A.RoutingHop_2008A> getRoutingHop() {
        if (routingHop == null) {
            routingHop = new ArrayList<RoutingHopType_2008A.RoutingHop_2008A>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class RoutingHop_2008A {
