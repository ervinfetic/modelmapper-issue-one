...
public class GuestCountType_2008A {

    @XmlElement(name = "GuestCount", required = true)
    protected List<GuestCountType_2008A.GuestCount_2008A> guestCount;
     ...
     * {@link GuestCountType_2008A.GuestCount_2008A }
     * 
     * 
     */
    public List<GuestCountType_2008A.GuestCount_2008A> getGuestCount() {
        if (guestCount == null) {
            guestCount = new ArrayList<GuestCountType_2008A.GuestCount_2008A>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class GuestCount_2008A {
