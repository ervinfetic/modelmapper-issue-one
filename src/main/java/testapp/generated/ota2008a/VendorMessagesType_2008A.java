...
public class VendorMessagesType_2008A {

    @XmlElement(name = "VendorMessage", required = true)
    protected List<VendorMessageType_2008A> vendorMessage;
     ...
     * {@link VendorMessageType_2008A }
     * 
     * 
     */
    public List<VendorMessageType_2008A> getVendorMessage() {
        if (vendorMessage == null) {
            vendorMessage = new ArrayList<VendorMessageType_2008A>();
        }
