...
@XmlEnum
public enum IncludeExcludeType_2008A {
    ...
    IncludeExcludeType_2008A(String v) {
        value = v;
    }
    ...
    public static IncludeExcludeType_2008A fromValue(String v) {
        for (IncludeExcludeType_2008A c: IncludeExcludeType_2008A.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
