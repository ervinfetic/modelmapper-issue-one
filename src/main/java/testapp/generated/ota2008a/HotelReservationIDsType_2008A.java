...
public class HotelReservationIDsType_2008A {

    @XmlElement(name = "HotelReservationID", required = true)
    protected List<HotelReservationIDsType_2008A.HotelReservationID_2008A> hotelReservationID;
     ...
     * {@link HotelReservationIDsType_2008A.HotelReservationID_2008A }
     * 
     * 
     */
    public List<HotelReservationIDsType_2008A.HotelReservationID_2008A> getHotelReservationID() {
        if (hotelReservationID == null) {
            hotelReservationID = new ArrayList<HotelReservationIDsType_2008A.HotelReservationID_2008A>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class HotelReservationID_2008A {
