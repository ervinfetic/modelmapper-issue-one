...
public class SpecialRequestType_2008A {

    @XmlElement(name = "SpecialRequest", required = true)
    protected List<SpecialRequestType_2008A.SpecialRequest_2008A> specialRequest;
     ...
     * {@link SpecialRequestType_2008A.SpecialRequest_2008A }
     * 
     * 
     */
    public List<SpecialRequestType_2008A.SpecialRequest_2008A> getSpecialRequest() {
        if (specialRequest == null) {
            specialRequest = new ArrayList<SpecialRequestType_2008A.SpecialRequest_2008A>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class SpecialRequest_2008A
